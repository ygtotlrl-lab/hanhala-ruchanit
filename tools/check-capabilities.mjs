...
/*  ⛔ הערה מכילה נימוק, ולא מצביע (סבב 97) — ⚠️ הנמדד הוא **דפוס המצבה**
...
const MATRIX = [
  ...
  /*  ⛔ הערה מכילה נימוק, ולא מצביע (סבב 97) — ⚠️ הנימוק המדוד: בסבבים 87–96
...
const GATES = {
  ...
  /*  ⭐ סבב 148 — ⛔ כל פסוקית נמנית: ⚠️ הציטוט שנמצא בתקן,
