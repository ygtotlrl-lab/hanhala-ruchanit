...
const APP = {
  ...
  tableProbe: {
    ...
    99:  (c) => !!c.fnBody('ysUsersCacheSave')
    ...
    98: (c) => !!c.fnBody('changeMyPassword')
...
export const ROWS = [39, 41, 42, 44, 59];
...
const MATRIX = [
  ...
  { row: 99, name: 'נתיב עדכון חלקי למראת המשתמשים', app: true },
  { row: 116, name: 'פינוי אוטומטי',
  ...
  { row: 98, name: 'מסך שינוי סיסמה עצמי', app: true },
  { row: 121, name: 'מטמון-CDN מראש עם ריפוי עצמי',
  ...
  { row: 121, name: 'מודול ה-service worker',
...
/*  ⭐ סבב 52 — נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 120, name: 'בדיקת עדכון תקופתית ל-service worker',
  ...
  { row: 119, name: 'אוטו-אפדייט מ-raw.githubusercontent',
...
const GATES = {
  ...
  90: { manual: '`onConflict` טרם נמדד בארבעתן' },
  ...
  110: { manual: 'קיום טבלה או מפתח במסד אינו נראה מהריפו' },
  111: { manual: 'מצב ההרצה יושב ב-`schema_migrations` ואינו נראה מהריפו' },
  ...
  115: { manual: 'מצב הענפים המרוחקים אינו נראה מעותק העבודה' },
