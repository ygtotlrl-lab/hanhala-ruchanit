...
const CANON = {
  ...
  tech: { name: 'בלוק "מידע טכני"',      sha: '804fb2312ebd2b15', lines: 50,
          start: '/* ═══ מידע טכני — מודול משותף (סבב 91)', end: '/* ═══════════════ סוף מודול מידע טכני' },
  sync: { name: 'בלוק "☁️ סנכרון"',      sha: 'b81819c149bb6da3', lines: 45,
          start: '/* ═══ אזור מצב — בלוק "☁️ סנכרון"', end: '/* ═══ סוף בלוק "☁️ סנכרון"' },
  backup: { name: 'מודול הגיבוי היומי', sha: '9feceea4c95065f1', lines: 344,
