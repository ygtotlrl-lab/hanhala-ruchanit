...
export const ROWS = [5, 8, 43, 187, 103];
...
const FLOOR = { shared: 24, app: 22, appWhy: 'מספר השערים והבודקים שהריפו נושא — כל שער פרטי מוסיף טענת תוכן' };
/* ⚠️ סוף פר-אפליקציה */
 ...
 *  שהשורה באה לסלק. */
{
   ...
   *  חי ביומן לצד `--text3` שבשלוש, ⛔ ורשימה של חמישה שמות לא תפסה
   ...
   *  ההפניה בלי הגדרה: ⭐ והוא נמדד כאן לכל שם ⛔ ולא לתשעה. */
  {
    ...
    if (!hit) {
      ...
      t(!runGateOn({ 'index.html': to('--text2') }, 'test_caps_ui.mjs', () => ({})),
