#!/usr/bin/env node
/* ───────────────────────────────────────────────────────────────────────────
   test_mignames.mjs — שם מיגרציה נגזר, ומותאם לרשומה שרצה
...
const APP = {
  ...
  migrations: {
    ...
    '002_revoke_log_tables.sql': null,
    '003_backup_retention.sql': null,
    '004_backup_retention_cron.sql': 'shared_004_backup_retention_cron',
    '005_structured_tables.sql': 'hanhala_005_structured_tables',
    '006_migrate_kv_to_rows.sql': 'hanhala_006_migrate_kv_to_rows',
    '007_users_updated_at_touch.sql': 'users_drop_deleted_add_touch_trigger',
    '008_student_id_to_text.sql': 'hanhala_008_student_id_to_text',
    '009_sleep_structured_tables.sql': 'hanhala_009_sleep_structured_tables',
    '010_migrate_sleep_kv_to_rows.sql': null,
    '011_users_drop_plaintext_password.sql': 'hanhala_011_users_drop_plaintext_password',
    '012_backup_retention_cap.sql': null,
    '013_kv_updated_at.sql': 'hanhala_013_kv_updated_at',
    '014_backup_allowlist_drop_wa_phone.sql': 'backup_allowlist_drop_wa_phone',
    '015_ys_settings.sql': 'ys_settings_table',
    '016_soft_delete_columns.sql': 'soft_delete_columns_shared',
    '017_migrate_settings_kv_to_rows.sql': null,
    '018_drop_kv_keys.sql': 'drop_kv_keys_final',
    '019_backup_allowlist_add_ys_settings.sql': 'backup_allowlist_add_ys_settings',
    '020_drop_cohort_year.sql': null,
    '021_soft_delete_ys_cls_years.sql': 'ys_settings_soft_delete_columns',
    '022_backup_allowlist_restore_ys_cls_years.sql': 'backup_allowlist_restore_ys_cls_years',
    '023_drop_ys_users_password_hash.sql': 'drop_plaintext_password_columns',
    '024_ys_sleep_treats_seed.sql': 'ys_sleep_treats_seed',
    '025_backup_anchor_diff_retention.sql': 'backup_anchor_diff_retention',
    '026_sleep_rows_stamp_from_date.sql': null,
    '027_drop_kv_table.sql': '027_drop_kv_table',
    '028_grant_retention_keys_anon.sql': '028_grant_retention_keys_anon',
    '029_stamp_bigint_drop_touch.sql': 'ys_029_stamp_bigint_drop_touch',
    '030_users_client_id_shape.sql': 'ys_030_users_client_id_shape',
    '031_kv_ownership_to_yoman.sql': null,
    '032_role_vocabulary_manager.sql': 'ys_role_vocabulary_manager',
    '033_ys_settings_value_json_check.sql': 'kv_value_json_check',
    '034_revoke_schema_grants.sql': null,
    '035_bk_fn_def.sql': 'bk_fn_def',
  ...
  migNoRecord: {
    ...
    '002_revoke_log_tables.sql': 'תוכנו רץ בשתי רשומות נפרדות — ⛔ ואין רשומה אחת שתואמת לו',
    '003_backup_retention.sql': 'אינו מיגרציה ואינו רץ — ⚠️ כל ה-SQL שבו מוער בכוונה',
    '010_migrate_sleep_kv_to_rows.sql': 'ההעברה רצה מעורך ה-SQL בלי רישום — ⛔ ואין רשומה שתוכנה זה',
    '012_backup_retention_cap.sql': 'תקרת העותקים רצה מעורך ה-SQL בלי רישום — ⛔ ואין רשומה שתוכנה זה',
    '017_migrate_settings_kv_to_rows.sql': 'ההעברה רצה מעורך ה-SQL בלי רישום — ⛔ ואין רשומה שתוכנה זה',
    '020_drop_cohort_year.sql': 'הגריעה רצה מעורך ה-SQL בלי רישום — ⛔ ואין רשומה שתוכנה זה',
    '026_sleep_rows_stamp_from_date.sql': 'החותמות נכתבו מעורך ה-SQL בלי רישום — ⛔ ואין רשומה שתוכנה זה',
    '031_kv_ownership_to_yoman.sql': 'הבעלות הועברה מעורך ה-SQL בלי רישום — ⛔ ואין רשומה שתוכנה זה',
    '034_revoke_schema_grants.sql': 'ההרשאות נשללו מעורך ה-SQL בלי רישום — ⛔ ואין רשומה שתוכנה זה',
  },
