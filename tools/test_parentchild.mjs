...
const APP = {
  ...
  dbSchema: DB_SCHEMA,
  /*  ⭐ זוגות אב-ובן ומצב המפתח הזר — ⛔ **אינו נגזר**: הזוג הוא החלטת סכימה, ⚠️ והמסד הוא מה שנמדד מולו */
  parentChild: [
  ...
  twoParents: {},
  /*  ⛔ הבן אינו ברשימת הדחיפה — ⚠️ הוא נגזר מרשומת האב ונכתב באותה
   *  קריאה, ⭐ ולכן הסדר נמדד **בגוף הכותב**: ⛔ שני האסימונים הם שמות
   *  התצורה, ⚠️ והם מה שמופיע בקוד ⛔ ולא שם הטבלה. */
  /*  ⛔ מפת האב-ובן החיה שבמקור — ⚠️ **ולמה `null` כאן**: שורות הבן
   *  **נגזרות** מרשומת האב בגוף הכותב ⛔ ואינן שורות עצמאיות, ⭐ ואין
   *  מפה שמונה אב ⟵ בניו: ⛔ הסדר כאן נמדד בגוף הכותב. */
   ...
   *  ⚠️ ואין כאן `deleted_at` ⛔ שהשורה הנגזרת אינה נושאת אותו. */
  inherit: {
