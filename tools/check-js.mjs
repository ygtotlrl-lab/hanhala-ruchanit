...
const APP = {
   ...
   *  שם השער ⟵ `'<מינימום>-<מקסימום>'` ונימוק; ⛔ **ומה מפיל**: שם שאינו
   *  שער, וטווח בלי נימוק. ⭐ **וההיעדר מוצהר ריק** ⛔ ואינו נשמט:
   *  ⚠️ שדה חסר נקרא «לא נשאל», וריק נקרא «נמדד ואין». */
  floorRange: {},
  floorRangeWhy: {},
...
function runGate(gate) {
  return new Promise((resolve) => {
    ...
    const _range = (APP.floorRange || {})[gate.replace(/\.mjs$/, '')] || '';
