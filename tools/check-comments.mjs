...
export const ROWS = [18, 20, 22, 25, 30, 26, 44, 71, 72, 73, 78];
...
/* ───────────────────────────────────────────────────────────────────────────
   ...
   **מה אינו נאכף כאן**.
   ...
   ⛔ **והמדידה מפילה** (סבב 79) — ⚠️ עד כאן היא דיווחה בלבד, ⭐ מפני
   שהקיימים נכתבו לפני הדרישה; ⛔ כולם נסגרו, ⛔ ומבחן חדש בלי ארבעתן מפיל.
   ──────────────────────────────────────────────────────────────────────── */
{
  ...
  else fail(`תקן הבאנר: ${full}/${seen} מבחנים נושאים את ארבע הפסקאות בסדר ` +
            `(${partial} חלקיים) — הצפוי ${seen}/${seen}. כותבים בבאנר את ארבע ` +
            `הפסקאות המסומנות, בסדר: מה נאכף · הנימוק המדוד · מה יישבר בלעדיו · ` +
            `מה אינו נאכף כאן`);
}
