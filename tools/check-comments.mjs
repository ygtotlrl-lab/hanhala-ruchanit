...
export const ROWS = [16, 20, 18, 19, 30, 23, 34, 40, 43, 85, 86, 87, 92];
 ...
 *  משמעות, ⛔ ואין שער שיכול לומר אותה. */
{
  ...
  for (let i = 0; i < md.length; i++) {
    ...
    if (!OPENERS.some((o) => c.startsWith(o))) bad.push(`${cells[1]} («${cells[2].slice(0, 24)}»): «${c.slice(0, 28)}»`);
  }
  if (bad.length)
  ...
  else pass(`פתיחת ההערה בטבלה — ${seen} הערות, כולן באחת משלוש`);
}
