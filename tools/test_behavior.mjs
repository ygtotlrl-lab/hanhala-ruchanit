...
const APP = {
   ...
   */
  fresh: { sel: '#auth-btn',
    why: 'כפתור הכניסה שבמסך הראשון — ⛔ ובהתקנה טרייה אין משתמש במסד: ⚠️ ומה שנמדד הוא שהמסך נפתח ושמיש, ⭐ ולא שהכניסה מצליחה' },
  ...
  accept: { expose: [], setup: '', cases: [], why: '⛔ אין כאן חשבון שחי באפליקציה אחת — ⚠️ הנוכחות, השינה והייבוא נמדדים במסלולים שלמעלה' },
