 ...
 *
 *  ⚠️ **הנקודה העיוורת שנמדדה ב-26.8:** `test_round40_gradle.mjs` השווה
 ...
 *  **ריפו git סינתטי בתיקייה זמנית**, מריצה בו את `test_round40_gradle.mjs`
...
const GATE = 'test_round40_gradle.mjs';
