...
const APP = {
  ...
  namePolicy: {
     ...
     *  שאין לה שם חי, ⛔ ושם חורג שאינו כאן. ⭐ **ולמה ריק**: 59 השמות
     *  שנשאו את `sl` הוסבו ל-`hr`, ⚠️ ואין מה להכריז. */
    ...
    retiredPrefix: {
      ys: 'תחילית המשפחה שקדמה לתחילית הריפו — ⛔ ושם שנושא אותה וחי בריפו אחד בלבד הוא שארית ההסבה',
      tb: 'תחילית הטבלאות הישנה של היומן — ⛔ ושם שנושא אותה וחי בריפו אחד בלבד הוא שארית ההסבה',
    },
    msgAllow: {},
    fnAllow: {},
    ...
    appTokens: {
      '--at-a': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--at-ak': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--at-ap': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--at-e': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--at-l': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--at-p': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--at-x': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--bad-line': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--brand-edge': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--brand-wash': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--info': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--info-soft': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--navy-fill': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--navy-ink': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--navy-2': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--navy-3': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--ok-line': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--warn-line': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
    },
    ...
    slotTokens: {
      '--at': 'חריץ הצבע של שורת הנוכחות — ⛔ כל הגדרה היא הקשר אחר, והקריאה אחת בכלל הבסיס',
      '--color': 'חריץ הדיו של שורת ההודעה',
      '--icbg': 'חריץ המשטח של האייקון',
      '--ty': 'חריץ הדיו של תווית הסוג',
      '--ty-bg': 'חריץ המשטח של תווית הסוג',
      '--ty-line': 'חריץ המסגרת של תווית הסוג',
    },
  },
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
...
/* ── המדידות ───────────────────────────────────────────────────────────── */
console.log(`· ${FACTS.slug} — שם נגזר מדפוס מוצהר`);
...
/*  ⛔ שם במודול משותף נושא את תחום המודול — ⚠️ **מה נכנס**:
...
/*  ⛔ ארבע המוטציות — ⚠️ התחילית שהוסבה והקבוע: ⭐ שתיהן
...
/*  ⛔ המוטציית-נגד סינתטית ⛔ ואינה נשענת על שם חי — ⚠️ ההסבה
...
console.log(bad ? `\n❌ ${FACTS.slug}: ${n} טענות, ${bad} נכשלו`
                : `\n✓ שם נגזר מדפוס מוצהר — ${n} טענות עברו, 0 נכשלו`);
