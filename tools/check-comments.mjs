 ...
 *  ⛔ והספירות שנמחקו משם שרדו בטבלה בלי שאיש מדד. */
{
   ...
   *  משתנה בגרשיים אחוריים שאחריו מספר סבב הוא עובדה קבועה. ⚠️ **ומדידה שהשער כן מריץ אינה בכלל הזה** —
   *  ⭐ «נמדד מול המסד» · «נמדד בדפדפן» · «נמדד בבריכה» · «נמדד
   *  בפרסר»: ⛔ הן חוזרות בכל הרצה, ⚠️ ואינן נושאות שם כלי בגרשיים
   *  אחוריים. */
