...
const APP = {
   ...
   *  שאינו בשני התפקידים בפועל מפיל אף הוא. ⭐ **וכאן היא ריקה** —
   *  ⚠️ `--navy` נפצל ל-`-ink` ול-`-fill`, ⛔ ולא נשאר אסימון כפול. */
  dualRoleAllow: {},
  /*  ⛔ צמד מוצהר שאינו מגיע ל-4.5 — ⚠️ כל צמד נושא את סיבתו, ⛔ וצמד
   *  שכן מגיע מפיל אף הוא. ⭐ **וכאן היא ריקה** — ⚠️ ששת הצמדים שחרגו
   *  היו כולם מהאסימון הדו-תפקידי, ⛔ והפיצול סגר אותם. */
  contrastAllow: {},
  tableProbe: {
