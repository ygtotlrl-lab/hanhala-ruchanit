...
const APP = {
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    157: (c) => c.hasCode(/YS_PASS_ITER\s*=\s*100000\b/)
    ...
    156: (c) => !!c.fnBody('ysUsersCacheSave')
    ...
    153: (c) => !!c.fnBody('changeMyPassword')
  ...
  probeInput: {
    ...
    '176|מטמון-CDN מראש עם ריפוי עצמי': 'src',
...
export const ROWS = [29, 40, 42, 44, 53, 82, 47, 149, 94, 133, 54, 22, 59, 25];
...
const MATRIX = [
  ...
  { row: 165, name: 'הערה שמתארת מצב שחלף',
  ...
  { row: 157, name: '`PBKDF2` — פרמטרים', app: true },
  ...
  { row: 148, name: 'רשימה אינה נושאת פריט כפול',
  ...
  { row: 167, name: 'פונקציה בלי קוראים',
  ...
  { row: 161, name: 'סודות אינם עוזבים את המכשיר',
    probe: () => {
  ...
  { row: 159, name: 'טביעה חסרה מושלמת אוטומטית',
  ...
  { row: 160, name: 'סיסמאות בענן — אין מסלול שכותב או קורא טקסט גלוי',
    probe: () => {
  ...
  { row: 163, name: 'דגלי מעבר — אין דגל דלוק',
  ...
  { row: 156, name: 'נתיב עדכון חלקי למראת המשתמשים', app: true },
  ...
  { row: 150, name: 'אימות פינוי מול הענן',
  ...
  { row: 176, name: 'מטמון-CDN מראש עם ריפוי עצמי',
  ...
  { row: 159, name: 'חסימת משתמש מושבת בכניסה אופליין',
  ...
  { row: 159, name: 'אימות מול טביעה בענן',
    probe: () => {
  ...
  { row: 176, name: 'מודול ה-service worker',
...
/*  ⭐ סבב 52 — נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 175, name: 'בדיקת עדכון תקופתית ל-service worker',
  ...
  { row: 174, name: 'עדכון אוטומטי — בדיקה מחזורית',
  ...
  { row: 151, name: 'קריאת ערך מספרי עוברת ב-readNum',
...
const GATES = {
  ...
  144: { claim: '`kv_rishon`' },
  170: { claim: 'ז. עמודה בלי קורא' },
  172: { claim: 'ח. הגדרה שהוחלפה' },
  ...
  95: { claim: 'BANNER_W' },
  168: { claim: ['אין מחלקת CSS שאינה מוחלת לעולם', 'אין מזהה id שאין לו קורא',
  ...
  158: { claim: 'pass_salt' },
  162: { manual: 'היעדר סוד נסרק ידנית; ⛔ שער טקסטואלי היה נכשל על כל מחרוזת' },
  164: { claim: '⏳' },
  49: { manual: 'התאמת הערה למציאות אינה ניתנת לאכיפה מכנית' },
  166: { claim: 'כל קובץ בעץ מוזכר במקום אחר' },
  171: { claim: 'ד. רשימת-היתר' },
  173: { manual: 'מצב הענפים המרוחקים אינו נראה מעותק העבודה' },
  ...
  149: { claims: { 'check-capabilities': 'cfgKeyGaps', test_dbfacts: 'ג. כל מפתח שהקוד מבקש' } },
};
