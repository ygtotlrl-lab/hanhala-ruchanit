...
const APP = {
  ...
  /*  ⛔ קובץ תשתית שקיים בחלק מהריפו (סבב 114) — ⚠️ כל שם נושא את הסיבה,
  ...
  perAppTools: {
    ...
    'test_attend.mjs':
      'שער הנוכחות — מודד את סימוני הנוכחות ואת נגזרותיהם, ולשאר אין מסך נוכחות',
    'test_dupsession.mjs':
      'שער כפילות הסדרים — מודד שאין שני סדרים לאותו שיעור ביום, ולשאר אין סדר יומי',
    'test_import.mjs':
      'שער הייבוא — מודד את קליטת המצבה מקובץ, ולשאר אין מסלול ייבוא',
    'test_sleep_rows.mjs':
      'שער השינה — מודד את שורות השינה ואת סימוניהן, ולשאר אין מסך שינה',
    'test_tables.mjs':
      'שער טבלאות המצבה — מודד את טבלאות התלמידים והסדרים, ולשאר אין מצבה',
    'test_window.mjs':
      'שער חלון המשיכה — מודד שכל קריאה לשכבת העימוד מצהירה חלון, ולשאר אין שכבת עימוד עם חלון',
