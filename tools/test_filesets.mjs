/* ───────────────────────────────────────────────────────────────────────────
   ...
   **מה אינו נאכף כאן:** ⛔ תוכן הקבצים — ⚠️ נמדד **הסט** בלבד, ⭐ והתוכן
   ...
   לראות את ארבעת הריפו. ⛔ הרשימה זהה בית-לבית בארבעת העותקים.
   ──────────────────────────────────────────────────────────────────────── */
...
const APP = {
  ...
  appGates: {
      ...
      'kvmeta': 'מודד את חותמת השורה שנכשלת-סגור ומחזירה אפס — ⛔ ולשלוש האחרות אין אות פולינג שנשען על מפתח-ערך',
