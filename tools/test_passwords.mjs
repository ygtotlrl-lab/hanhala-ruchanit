...
const APP = {
  ...
  migrationA: '011_users_drop_plaintext_password.sql',
  migrationB: '023_drop_ys_users_password_hash.sql',
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
...
const FLOOR = { shared: 5, app: 12, appWhy: 'מסלולי הסיסמה — גזירת הטביעה, האימות והמראה קיימים בשלוש שיש בהן כניסה' };
/* ⚠️ סוף פר-אפליקציה */
