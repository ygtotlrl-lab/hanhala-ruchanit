...
const APP = {
  ...
  gapRows: [221, 48, 138, 142, 166, 68, 151, 107],
  ...
  probeInput: {
    ...
    '104|סולם אחד לגודל, לריווח ולרדיוס': 'src',
    '105|אין סגנון מוטבע': 'src',
    '107|גרף נבנה מ-CSS ולא מספרייה': 'src',
    '200|הערה שמתארת מצב שחלף': 'mixed',
    '209|שאילתת `@media` מתה': 'src',
    '124|ספרייה חיצונית — גרסה מוצהרת': 'src',
    '125|ייצוא והנפקה — דרך מוצהרת': 'src',
    '108|המסמך מתפרסר נקי': 'src',
    '109|לוג מסלול — תג ורמה': 'src',
...
export const ROWS = [32, 47, 49, 51, 60, 96, 58, 180, 114, 158, 63, 25, 68, 28, 37, 41];
...
const MATRIX = [
  ...
  { row: 104, name: 'סולם אחד לגודל, לריווח ולרדיוס',
  ...
  { row: 107, name: 'גרף נבנה מ-CSS ולא מספרייה',
  ...
  { row: 109, name: 'לוג מסלול — תג ורמה',
...
const GATES = {
  ...
  56: { claims: { test_rowscan: ['יא · נימוק ⭕ מונה את מה שאינו נאכף'] } },
  ...
  116: { claims: { test_period: ['[verb-registry]', '[verb-old-name]'] } },
  ...
  113: { claims: { test_sistername: ['[sister-comment]', '[sister-ambig]'] } },
  ...
  34: { claim: 'מסלול «' },
  59: { claim: 'א · אין שתי שורות על אותו probe' },
  ...
  49: { claim: 'הערה ריקה' },
  51: { claim: 'COUNT_NOTE' },
  55: { manual: 'עדכון הסימון הוא התנהגות סשן שאינה בעץ — ⛔ נאכף רק בתוצאתו' },
  ...
  106: { claims: { test_visual: ['ליטרל צבע בגיליון', 'ערך שאינו דרגה בסולם', 'ערך מספרי שאינו נגזר'] } },
  ...
  60: { claims: { 'check-capabilities': ['sha:', 'orderGaps', 'blockRowGaps'],
  ...
  111: { claim: 'עברית' },
  114: { claims: { 'check-comments': 'RULE_W', 'check-capabilities': 'bannerGaps' } },
  115: { claim: 'BANNER_W' },
  ...
  63: { claims: { 'check-capabilities': 'רענון הממתינים', test_push: 'ה. כשל רשת' } },
  ...
  110: { manual: '«קורא סביר יופתע» אינו נגזר מהטקסט — ⛔ נאכף בתוצאתו בלבד' },
