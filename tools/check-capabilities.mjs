...
const APP = {
  ...
  gapRows: [94, 98, 114, 117, 118, 121, 127],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    131: (c) => c.hasCode(/YS_PASS_ITER\s*=\s*100000\b/)
    ...
    130: (c) => !!c.fnBody('ysUsersCacheSave')
    ...
    105: (c) => !/ysCfgSet\('(?:ys_students|ys_attend_sessions|ys_sleep_sessions)'/.test(c.src)
    ...
    129: (c) => !!c.fnBody('changeMyPassword')
