...
const APP = {
  ...
  appClasses: {
    'auth-box':
      'תיבת הכניסה בהנהלה צרה יותר — שדה הסיסמה כאן הוא שש ספרות, ושורת ההסבר שמתחתיו קצרה — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
    'auth-btn':
      'כפתור הכניסה בהנהלה נושא את רדיוס הכפתורים של המערכת ואת מצב הלחיצה שלה — המסך מיועד למגע ואין בו ריחוף — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
    'back':
      'כפתור החזרה בהנהלה הוא כפתור ממוסגר בשורת הכותרת — הוא יושב לצד כותרת המודול ולא מעליה, ולכן הוא תיבה ולא קישור — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
    'badge':
      'תג בהנהלה נושא ריווח רחב יותר — הוא מציג מצב נוכחות בשורת תלמיד, והוא נקרא בזמן הקראת שמות ממרחק — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
    'btn':
      'כפתור בהנהלה נושא מסגרת בגוון המילוי ומצב ריחוף מורם — המסכים כאן נפתחים גם בטאבלט עם עכבר, ויש בהם שורת כפתורים צפופה — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
    'hero':
      'הכותרת הגדולה בהנהלה היא משטח מדורג בגוון הזהות — היא נושאת את שם הישיבה ואת בורר השיעור, ואינה פריסת טור של כרטיס — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
    'stat':
      'תא המונה בהנהלה הוא עמודה בשורת סיכום שמחולקת בקו — ואינו כרטיס עצמאי עם מסגרת ורקע משלו — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
  },
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
