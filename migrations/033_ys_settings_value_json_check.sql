-- ============================================================================
-- 033_ys_settings_value_json_check.sql — ערך במפתח-ערך הוא JSON
-- ============================================================================
--
-- ⛔ **רץ במסד.**
--
-- ⛔⛔ **מה הקובץ עושה:** ⚠️ מוסיף אילוץ `check` על עמודת `value` ב-`ys_settings` —
...
begin
  if not exists (
    ...
    where conname = 'ys_settings_value_json' and conrelid = 'public.ys_settings'::regclass
  ) then
    alter table public.ys_settings
      add constraint ys_settings_value_json
