...
const APP = {
  ...
  appTokens: {
    ...
    '--brand-edge': 'קו הגבול של סרגל הזהות — מוצר ולא תשתית, ואינו בארבעתן',
    '--brand-wash': 'שטיפת הזהות מאחורי הסרגל העליון — מוצר ולא תשתית',
    '--danger': 'דיו הסכנה של פעולות מחיקה — מוצר ולא תשתית, ואינו בארבעתן',
    '--danger-bg': 'המילוי שמתחת לדיו הסכנה — משטח ולא דיו, ומוצר ולא תשתית',
    '--danger-line': 'קו הגבול של אזור הסכנה — מוצר ולא תשתית, ואינו בארבעתן',
    '--info': 'דיו ההודעה המסבירה — מוצר ולא תשתית, ואינו בארבעתן',
    '--info-bg': 'המילוי שמתחת לדיו ההודעה — משטח ולא דיו, ומוצר ולא תשתית',
    '--navy-fill': 'המילוי הכחול העמוק של הסרגל — מוצר ולא תשתית, ואינו בארבעתן',
    ...
    '--ok': 'דיו ההצלחה של חיווי הסנכרון — מוצר ולא תשתית, ואינו בארבעתן',
    '--ok-bg': 'המילוי שמתחת לדיו ההצלחה — משטח ולא דיו, ומוצר ולא תשתית',
    '--ok-line': 'קו הגבול של אזור ההצלחה — מוצר ולא תשתית, ואינו בארבעתן',
    '--shadow2': 'הצל העמוק של המודאל — דרגה שנייה למושג הצל, ומוצר ולא תשתית',
    '--warn': 'דיו האזהרה של אזור המצב — מוצר ולא תשתית, ואינו בארבעתן',
    '--warn-bg': 'המילוי שמתחת לדיו האזהרה — משטח ולא דיו, ומוצר ולא תשתית',
    '--warn-line': 'קו הגבול של אזור האזהרה — מוצר ולא תשתית, ואינו בארבעתן',
  },
 ...
 *  הבהירה וגוף ה-CSS, ⛔ **ומה מפיל**: שם מאוצר המילים שאינו מוגדר · שם
 ...
 *  ⛔ **ושלוש הרמות באוצר המילים** — ⭐ נמדד שכולן קיימות בארבעת הריפו,
 *  ⚠️ ולכן זה מושג אחד ⛔ ולא שניים. */
