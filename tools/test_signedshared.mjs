...
const APP = {
   ...
   *  בעצמה השארית שהשער בא לסלק. ⚠️ **כולם נמדדו בסבב 84 ונרשמו**,
   *  ⛔ והכנסתם לבלוק היא סבב משלה ואינה תופעת לוואי כאן. */
  unsignedAllow: {
    isStaleSchema: 'האזנה לסכימה ישנה (סבב 83) — ⛔ נכתבה בארבעתן באותו סבב ומעולם לא נכנסה לבלוק, ⚠️ והכנסתה היא סבב משלה',
    _staleBanner: 'האזנה לסכימה ישנה (סבב 83) — ⛔ נכתבה בארבעתן באותו סבב ומעולם לא נכנסה לבלוק, ⚠️ והכנסתה היא סבב משלה',
    staleSchemaHalt: 'האזנה לסכימה ישנה (סבב 83) — ⛔ נכתבה בארבעתן באותו סבב ומעולם לא נכנסה לבלוק, ⚠️ והכנסתה היא סבב משלה',
    sbWatch: 'עוטף הלקוח שמאזין לתשובות המסד (סבב 83) — ⛔ זהה בארבעתן ומחוץ לכל בלוק, ⚠️ והוא נקודת ההאזנה של האזור כולו',
    techInfoHTML: 'אזור «מידע טכני» — ⛔ הבלוק החתום מכסה את «☁️ סנכרון» בלבד, ⚠️ ושלוש הפונקציות האלה יושבות מחוצה לו',
    techInfoToggle: 'אזור «מידע טכני» — ⛔ הבלוק החתום מכסה את «☁️ סנכרון» בלבד, ⚠️ ושלוש הפונקציות האלה יושבות מחוצה לו',
    techInfoMount: 'אזור «מידע טכני» — ⛔ הבלוק החתום מכסה את «☁️ סנכרון» בלבד, ⚠️ ושלוש הפונקציות האלה יושבות מחוצה לו',
    lsToast: 'עוזר ההודעה של מודול האחסון — ⛔ הוא משרת את הבלוק ויושב מחוצה לו',
    esc: 'עוזר בריחת HTML — ⛔ זהה בשניים מהריפו ומחוץ לכל בלוק',
  },
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
