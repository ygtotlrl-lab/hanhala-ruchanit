...
const APP = {
  ...
  probeInput: {
    ...
    '195|מיכל באנר העדכון במקור': 'src',
    '195|הרענון מ-controllerchange בלבד': 'src',
    '195|סימן דחיית הבאנר מתמיד': 'src',
    '108|רישום כשלי כתיבה': 'src',
    '58|חלון חם במכשיר': 'src',
    '169|מסך שינוי סיסמה עצמי': 'src',
    '197|מטמון-CDN מראש עם ריפוי עצמי': 'src',
...
const MATRIX = [
  ...
  { row: 197, name: 'מטמון-CDN מראש עם ריפוי עצמי',
  ...
  { row: 197, name: 'מודול ה-service worker',
...
/*  ⭐ סבב 52 — נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 196, name: 'בדיקת עדכון תקופתית ל-service worker',
  ...
  { row: 195, name: 'מיכל באנר העדכון במקור',
  ...
  { row: 195, name: 'הרענון מ-controllerchange בלבד',
    probe: () => swReloadGaps().length === 0 },
  { row: 195, name: 'סימן דחיית הבאנר מתמיד',
    probe: () => swDismissGaps().length === 0 },
  { row: 195, name: 'עדכון אוטומטי — בדיקה מחזורית',
