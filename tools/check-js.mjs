...
const APP = {
  ...
  rules: [
    ...
    ['sw',   "startsWith\\('hanhala-ruchanit-'\\)", true,
             "sw.js: ניקוי מטמון לפי הקידומת 'hanhala-ruchanit-' בלבד"],
  ...
  gates: ['check-structure.mjs', 'check-status-area.mjs', 'check-docs.mjs',
          ...
          'test_round40_gradle.mjs', 'test_round40_shell.mjs', 'test_round40_devid.mjs',
