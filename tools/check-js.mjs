...
const BUDGET_EXEMPT = {
  ...
  'test_readonly.mjs':  'מריץ את הסט המלא על עותק — ⛔ קו הבסיס המוכרז, ' +
                        'והוא היחיד שרשאי לכך; נמדד 17.4–23.0 שניות לבדו',
  'test_crossgate.mjs': 'משווה ארבעה שערים זה מול זה, ⛔ וכל מוטציה מריצה ' +
                        'שניים מהם על עותק אחד משותף; נמדד 11.6–12.6 שניות לבדו',
  /*  ⛔ החריגה הזו אינה אחידה בארבעתם — ⚠️ נמדד 18.8–19.6 שניות בשתיים
   *  ו-28.4–31.6 בשתיים, ⭐ ששורות הטבלה שאינן מוחרגות בהן רבות יותר. */
  'test_matrix.mjs':    'הופך תא בטבלה ומריץ את check-capabilities על עותק ' +
                        'אחד משותף, ⛔ פעם לכל שורה שאינה מוחרגת; נמדד ' +
                        '18.8–31.6 שניות לבדו',
