-- ============================================================================
-- 006_migrate_kv_to_rows.sql — פירוק מפתחות ה-kv לשורות
-- ============================================================================
--
...
-- עדכנו בינתיים. ⛔ זו הנקודה שאסור להפוך ל-`do update`:
...
-- — חותמת שנוצרת בזמן ההעברה הייתה **חדשה מכל עריכה מקומית
...
-- 2. ys_marks — הבן
-- ───────────────────────────────────────────────────────────────────────────
-- ⭐ **מפתח ה-`marks` עובר כמחרוזת, בלי סינון וללא המרה**.
-- הגרסה שרצה סיננה `m.key ~ '^\d+$'` והמירה `::smallint`,
...
-- -- נבדק (לפני ההרצה): 273 סדרים · 13,083 סימונים · 71 תלמידים.
