...
const BUDGET_EXEMPT = {
  ...
  /*  ⛔ `test_rulesdocs` נמדד מחדש (סבב 86), שלוש הרצות לבדו בכל ריפו —
   *  ⚠️ 10.9–12.4 · 10.4–10.8 · 8.7–9.1 · 8.4–9.0 שניות: ⭐ **ולא נוסף לו
   *  דבר** — 37 קריאות הרתמה לפני ואחרי, ⛔ ומה שגדל הוא **מחיר הקריאה**:
   *  `check-capabilities` נמדד 858 מ״ש בראש הענף הקודם ו-920 כאן, ⚠️ והוא
   *  רץ בתוכו ארבע פעמים. ⛔ והפער מול 6.6–8.8 שנמסרו אינו הסבב הזה —
   *  ⭐ באותו ראש קודם עצמו נמדד 9.9–11.3, ⚠️ כלומר המספר שנמסר נמדד על
   *  מכונה אחרת: ⛔ מדידה על מכונה אחת אינה תקפה לאחרת.
   *  ⛔ והוא **נשאר** — ⚠️ הורדתו בסבב 81 נשענה על מדידה אחת וחזרה. */
  'test_rulesdocs.mjs': 'מריץ 37 קריאות רתמה — 21 ריצות פנימיות · 12 ' +
                        'check-comments · 4 check-capabilities, ⛔ כל אחת שער ' +
                        'אמיתי בתהליך נפרד; נמדד 8.4–12.4 שניות לבדו',
};
