...
export const ROWS = [5, 8, 43, 183, 101];
 ...
 *  שהשורה באה לסלק. */
{
   ...
   *  משתמשים אין לה מה למוטט כאן. */
  {
    ...
    /*  ⛔ הנמדד הוא **האתר** ⛔ ולא השם — ⚠️ הקבוע מוצהר בארבעתן בבלוק
   ...
   *  מפיל — ⚠️ הנמדד הוא **שהאסימון מוצהר**, ⛔ ולא השם שהוא נושא. */
  {
     ...
     *  הארבע, ⭐ ושם קשיח היה מפיל שלוש מהן. */
   ...
   *  בארבעתן» ⛔ ואינו אומר מה האסימון משרת. ⭐ **והנימוק המדוד**: כל שם
   *  שהרשימה מחזיקה אינו בארבעתן — ⚠️ זו המדידה שהכניסה אותו לשם,
   *  ⛔ והיא אינה מסבירה למה התפקיד אינו קיים בשאר. */
  {
    ...
    if (!m) {
      ...
      t(runGateOn({ 'tools/check-capabilities.mjs':
                      swap('המילוי של הכרטיס — מוצר ולא תשתית, ואינו בארבעתן') },
                  'test_caps_ui.mjs', () => ({})),
