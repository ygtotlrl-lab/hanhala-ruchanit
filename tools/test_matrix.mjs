...
const FLOOR = { shared: 234, app: 5, appWhy: 'מספר השורות והשערים — כל שער פרטי מוסיף טענת מטריצה' };
/* ⚠️ סוף פר-אפליקציה */
...
/*  ⛔ השורות שהיפוך התא שלהן אינו נמדד (סבב 168) — ⚠️ **מה נכנס**: שורה
...
const EXEMPT = [
  18, 19, 23, 24, 25, 30, 33, 34, 35, 38, 39, 43, 45, 47, 49, 52, 53, 57, 59,
  60, 61, 67, 72, 84, 90, 91, 93, 96, 106, 114, 117, 120, 121, 122, 123, 124,
  125, 137, 138, 140, 143, 157, 166, 168, 170, 178, 179, 182, 190, 191, 197,
  202, 210, 212, 213, 216, 217, 218, 222, 223, 224, 225, 232
];
