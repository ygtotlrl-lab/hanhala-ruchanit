...
export const ROWS = [29, 31, 32, 38, 44, 59];
...
const MATRIX = [
  ...
  { row: 120, name: 'מטמון-CDN מראש עם ריפוי עצמי',
  ...
  { row: 71, name: 'מעטפת WebView חתומה',
  ...
  { row: 78, name: 'בניית APK אחידה עם שער חתימה',
    probe: () => {
  ...
  { row: 120, name: 'מודול ה-service worker',
...
/*  ⭐ סבב 52 — נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 119, name: 'בדיקת עדכון תקופתית ל-service worker',
  ...
  { row: 118, name: 'אוטו-אפדייט מ-raw.githubusercontent',
...
const GATES = {
  ...
  20: { claim: 'MD_SPLIT' },
  22: { claim: 'gen-icons' },
  23: { manual: 'תקן תוכן הבודקים טרם נכתב — טרם נמדד' },
  24: { claim: 'const SHARED' },
  25: { claim: 'const EXEMPT' },
  26: { manual: 'תקן תוכן המבחן טרם נכתב — טרם נמדד' },
  27: { manual: 'המונה מדווח ואינו מפיל: 85 מבחנים נכתבו לפני הדרישה, והפלה רטרואקטיבית חוסמת כל דחיפה' },
  28: { manual: 'תקן תוכן המוטציה טרם נכתב — טרם נמדד' },
  29: { claim: 'כיסוי הטבלה' },
  30: { claim: 'עמודת «מה זה» היא הוראה מחייבת' },
  31: { claim: 'מספור רציף ובלי כפילויות' },
  32: { claim: 'הערה ריקה' },
  33: { claim: 'drift' },
  ...
  37: { claim: 'תווית מוטציה מודפסת' },
  38: { claim: 'export const ROWS' },
  39: { claim: 'תקן הבאנר' },
  40: { claim: 'דפוס הבודקים' },
  41: { claim: 'מספרי הבאנר' },
  42: { claim: 'ריצת check-js' },
  43: { claim: 'מכריז היעדר' },
  44: { claim: 'sha:' },
  55: { claim: 'CANON' },
  59: { claim: 'storage' },
  60: { manual: 'דפוס הודעת השגיאה טרם הוכרע, ואין מה לאכוף' },
  ...
  67: { claim: 'מספר סבב' },
  68: { claim: 'CSS מתות' },
  69: { manual: '«האם ההערה עדיין נכונה» הוא התאמה למציאות ולא צורה — ⛔ שער מודד צורה בלבד' },
  70: { claim: 'מפנה לקובץ' },
  72: { claim: 'android/app/src/main' },
  74: { claim: 'fgDriftMax' },
  75: { claim: 'CANON_MANIFEST' },
  77: { claim: 'BUILD_SHA' },
  79: { claim: 'versionCode' },
  81: { claim: 'WebView' },
  ...
  89: { manual: '`onConflict` טרם נמדד בארבעתן' },
  95: { claim: 'type=password' },
  96: { claim: 'aria-label' },
  99: { manual: 'שני מנועי תאריך — ⛔ טרם הוכרע איזה, ואין מה לאכוף' },
  100: { manual: '«`catch` ריק סביב כתיבה» טרם נוסח כשער — נסרק ידנית בכל סבב שנוגע' },
  102: { claim: 'pass_salt' },
  ...
  109: { manual: 'קיום טבלה או מפתח במסד אינו נראה מהריפו' },
  110: { manual: 'מצב ההרצה יושב ב-`schema_migrations` ואינו נראה מהריפו' },
  111: { manual: '«קובץ בלי קורא» דורש סריקה על ארבעת הריפו — נעשה ידנית' },
  112: { manual: 'קיום מפתח במסד אינו נראה מהריפו' },
  113: { manual: 'רשימת-היתר הגיבויים יושבת במיגרציה שכבר רצה' },
