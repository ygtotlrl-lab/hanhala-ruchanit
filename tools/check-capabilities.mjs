...
export const ROWS = [30, 32, 33, 39, 45, 60];
...
const GATES = {
  ...
  19: { claim: 'CANON_MD' },
  20: { claim: 'MD_SPLIT' },
  22: { claim: 'תוכן הקבצים הנלווים' },
  23: { claim: 'gen-icons' },
  24: { manual: 'תקן תוכן הבודקים טרם נכתב — טרם נמדד' },
  25: { claim: 'const SHARED' },
  26: { claim: 'const EXEMPT' },
  ...
  30: { claim: 'כיסוי הטבלה' },
  31: { claim: 'עמודת «מה זה» היא הוראה מחייבת' },
  32: { claim: 'מספור רציף ובלי כפילויות' },
  33: { claim: 'הערה ריקה' },
  34: { claim: 'drift' },
  35: { claim: 'measure-gap' },
  36: { manual: 'זמן ריצה נמדד ידנית בהרצה — ⛔ שער שמודד זמן מודד את המכונה' },
  37: { manual: 'חפיפה בין שערים נסרקת ידנית — ⛔ «אותה טענה» היא קריאת משמעות' },
  38: { claim: 'תווית מוטציה מודפסת' },
  39: { claim: 'export const ROWS' },
  40: { claim: 'תקן הבאנר' },
  41: { claim: 'דפוס הבודקים' },
  42: { claim: 'מספרי הבאנר' },
  43: { claim: 'ריצת check-js' },
  44: { claim: 'מכריז היעדר' },
  45: { claim: 'sha:' },
  56: { claim: 'CANON' },
  60: { claim: 'storage' },
  61: { manual: 'דפוס הודעת השגיאה טרם הוכרע, ואין מה לאכוף' },
  ...
  68: { claim: 'מספר סבב' },
  69: { claim: 'CSS מתות' },
  70: { manual: '«האם ההערה עדיין נכונה» הוא התאמה למציאות ולא צורה — ⛔ שער מודד צורה בלבד' },
  71: { claim: 'מפנה לקובץ' },
  ...
  91: { manual: '`onConflict` טרם נמדד בארבעתן' },
