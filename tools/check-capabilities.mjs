...
const APP = {
  ...
  probeInput: {
    ...
    '187|מפתח אחסון בלי קורא': 'src',
    '37|שער מריץ את כל טענותיו': 'tools',
    '89|שכבת המראה': 'src',
    '188|הגירה מקומית שהושלמה': 'mixed',
    ...
    '182|הערה שמתארת מצב שחלף': 'mixed',
    '189|שאילתת `@media` מתה': 'src',
    ...
    '180|דגלי מעבר — אין דגל דלוק': 'src',
    ...
    '196|מיכל באנר העדכון במקור': 'src',
    '196|הרענון מ-controllerchange בלבד': 'src',
    '196|סימן דחיית הבאנר מתמיד': 'src',
    '108|רישום כשלי כתיבה': 'src',
    '58|חלון חם במכשיר': 'src',
    '169|מסך שינוי סיסמה עצמי': 'src',
    '198|מטמון-CDN מראש עם ריפוי עצמי': 'src',
...
const MATRIX = [
  ...
  { row: 182, name: 'הערה שמתארת מצב שחלף',
  ...
  { row: 185, name: 'פונקציה בלי קוראים',
  ...
  { row: 180, name: 'דגלי מעבר — אין דגל דלוק',
  ...
  { row: 198, name: 'מטמון-CDN מראש עם ריפוי עצמי',
  ...
  { row: 198, name: 'מודול ה-service worker',
...
/*  ⭐ סבב 52 — נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 197, name: 'בדיקת עדכון תקופתית ל-service worker',
  ...
  { row: 196, name: 'מיכל באנר העדכון במקור',
  ...
  { row: 196, name: 'הרענון מ-controllerchange בלבד',
    probe: () => swReloadGaps().length === 0 },
  { row: 196, name: 'סימן דחיית הבאנר מתמיד',
    probe: () => swDismissGaps().length === 0 },
  { row: 196, name: 'עדכון אוטומטי — בדיקה מחזורית',
...
const GATES = {
  ...
  195: { claims: { test_sistername: ['[sister-name]', '[sister-asset]'] } },
  ...
  184: { claims: { test_removals: 'מזהה שנמחק ונשאר לו קורא',
  ...
  105: { claim: 'BANNER_W' },
  186: { claim: ['אין מחלקת CSS שאינה מוחלת לעולם', 'אין מזהה id שאין לו קורא',
  ...
  181: { claim: '⏳' },
  183: { claim: 'כל קובץ בעץ מוזכר במקום אחר' },
  191: { claim: 'ט. ערך נגזר שהתיישן' },
  193: { claim: 'ח. הגדרה שהוחלפה' },
  192: { claim: 'ד. רשימת-היתר' },
  194: { manual: 'מצב הענפים המרוחקים אינו נראה מעותק העבודה' },
