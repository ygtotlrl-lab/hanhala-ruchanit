...
const APP = {
  ...
  actMap: 'DOM_ACTIONS',
  gapRows: [104, 108, 125, 126, 127, 131, 132, 135, 141],
...
const GATES = {
  ...
  125: { manual: 'קיום רשומה בלי חותמת יושב במסד ואינו נראה מהריפו — ⛔ המדידה היא פעולת מנהל' },
  135: { manual: 'חתימת הסכימה החיה נגזרת מ-`information_schema` ואינה נראית מהריפו — ⛔ ההשוואה היא פעולת מנהל' },
  ...
  157: { manual: 'רשימת-היתר הגיבויים יושבת במיגרציה שכבר רצה' },
  159: { manual: 'מצב הענפים המרוחקים אינו נראה מעותק העבודה' },
  89: { claim: 'CLEANUP_SHA' },
  90: { claim: 'בלוק ה-APP' },
  136: { claim: 'cfgKeyGaps' },
};
