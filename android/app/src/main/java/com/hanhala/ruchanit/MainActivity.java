...
/**
 * Native WebView shell for hanhala-ruchanit — deliberately NOT a Trusted Web Activity.
 *
 ...
 * and is not affected. Same reasoning as yoman-avoda, schar-limud and gius — see
 * android/README.md.
 *
 ...
 * data loss of attendance records and student data. See android/README.md.
 *
 ...
 * hanhala-ruchanit's code has no navigator.share at all, so the bridge — and the reach it
...
public class MainActivity extends Activity {
    ...
    private static final String APP_URL = "https://ygtotlrl-lab.github.io/hanhala-ruchanit/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s.setDomStorageEnabled(true);          // localStorage — ys_* caches and the pending map live here
    ...
    private void showOfflinePage() {
        ...
        String html =
            ...
            + "a{background:#1a3c6e;color:#fff;text-decoration:none;padding:12px 28px;border-radius:10px;font-weight:700}"
            + "</style></head><body>"
            + "<h1>אין חיבור לאינטרנט</h1>"
            + "<p>הנהלה רוחנית לא הצליחה להתחבר.<br>בדוק את החיבור ונסה שוב.</p>"
