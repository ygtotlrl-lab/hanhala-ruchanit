...
-- ============================================================================
-- ⛔ **רץ במסד.** ⛔ מיגרציה שכבר רצה אינה נערכת — ⚠️ המסד החיל אותה, ועריכה
--    שלה יוצרת מצב שבו הקובץ שבריפו מתאר משהו אחר ממה שרץ; ⛔ שינוי מבני
--    נעשה בקובץ הבא בתור, ⛔ ולא בעריכת `004`.
--
