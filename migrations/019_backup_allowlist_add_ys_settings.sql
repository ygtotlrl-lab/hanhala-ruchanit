...
-- ============================================================================
--
-- ⛔ **רץ במסד.** ⚠️ הבאנר אמר «נכתב ולא רץ» עד סבב 82, ⛔ ונמדד שהוא שגוי:
--    ⭐ הרשימה החיה מכילה את `ys_settings`, ⛔ שנוסף כאן ואינו ב-`014`.
--    ⛔ מיגרציה שכבר רצה אינה נערכת, ולכן השינוי הוא קובץ חדש
--    ולא עריכה של `014` — ⚠️ ותיקון הבאנר הוא הצהרה על מצב ההרצה,
--    ⛔ ואינו שינוי במה שרץ.
--
