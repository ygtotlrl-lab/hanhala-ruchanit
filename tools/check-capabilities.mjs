...
const APP = {
  ...
  gapRows: [226, 140, 144, 168, 66, 153, 108],
...
export const ROWS = [33, 48, 49, 58, 96, 56, 182, 115, 160, 61, 26, 66, 29, 38, 42, 198];
...
const GATES = {
  ...
  201: { claims: { test_filesets: ['[oneoff-gate]', '[oneoff-round]', '[oneoff-stale]'] } },
