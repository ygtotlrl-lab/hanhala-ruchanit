...
const BUDGET_EXEMPT = {
  /*  ⛔ שלושה שערים חוצים את התקרה **לבדם**, ⛔ ואיש לא מחק אותם ולא הרים
   ...
   *  היא של סבב 75, לבד ולא בבריכה. */
  /*  ⛔ הפער בין הריפו גדול מפי שניים ⛔ ואינו סטייה — ⚠️ השער מריץ את
   *  **הסט המלא** של האפליקציה על עותק, ⭐ ומספר השערים שלה הוא מה שקובע. */
  'test_readonly.mjs':  'מריץ את הסט המלא על עותק — ⛔ קו הבסיס המוכרז, ' +
                        'והוא היחיד שרשאי לכך; נמדד 21.4–36.3 שניות לבדו',
  'test_crossgate.mjs': 'משווה ארבעה שערים זה מול זה, ⛔ וכל מוטציה מריצה ' +
                        'שניים מהם על עותק אחד משותף; נמדד 13.5–15.7 שניות לבדו',
  /*  ⛔ החריגה הזו אינה אחידה בארבעתם — ⚠️ נמדד 17.9–18.0 שניות בשתיים
   *  ו-27.4–27.8 בשתיים, ⭐ ששורות הטבלה שאינן מוחרגות בהן רבות יותר. */
  'test_matrix.mjs':    'הופך תא בטבלה ומריץ את check-capabilities על עותק ' +
                        'אחד משותף, ⛔ פעם לכל שורה שאינה מוחרגת; נמדד ' +
                        '17.9–27.8 שניות לבדו',
  ...
  /*  ⛔ `test_rulesdocs` ירד מכאן (סבב 81) — ⚠️ נמדד לבדו 8.5 · 7.9 · 6.5 ·
   *  6.4 שניות, ⛔ כלומר מתחת לתקרה בארבעתם: ⭐ חריגה שנימוקה חדל להתקיים
   *  היא שארית. ⚠️ ואין כאן סיכון להבהוב — ⛔ שער לא-מוחרג שחוצה בבריכה
   *  נמדד שוב לבדו, ⭐ ורק המדידה הבודדת מפילה. */
};
