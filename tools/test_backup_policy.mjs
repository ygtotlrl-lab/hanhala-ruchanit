 ...
 *
 *  ⚠️ שמו הקודם היה `test_round61_backup_policy.mjs` (השם השתנה בסבב
 *  67 — שם המבחן נגזר מהנושא ולא ממספר הסבב). ⛔ מיגרציות שכבר רצו
 *  (`012` בפרויקט המשותף, `008` בגיוס) מפנות לשם הישן, ⛔ ואין
 *  לערוך אותן.
