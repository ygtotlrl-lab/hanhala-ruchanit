...
const APP = {
   ...
   *  מסומנות «לא רלוונטי» בשורה 48 שבמטריצה. מה שכן כישלון הוא אתר
   *  שקיים ואינו עטוף. */
  ...
  idNames: [],
  /*  ⚠️ ירד מ-47 ל-40 בסבב 67 — שבעה אתרים עברו ל-`data-id` ודלגציה
   *  (כלל ברזל 27). ⛔ 29 הנותרים נושאים `event.stopPropagation()`
   *  ואינם ניתנים להמרה בלי לשנות את סדר הבועות. ⛔ ההמרה של 26 הנותרים
   *  קשורה בטבורה לשכבת המודאל (סבב 68) — רובם סוגרים דיאלוג דינמי, ⛔ ולכן
   *  היא נעשית יחד איתה ולא לפניה. */
  sites: 40,
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
