...
const APP = {
  ...
  gapRows: [218, 48, 137, 141, 165, 68, 150, 106],
  ...
  probeInput: {
    ...
    '217|מיכל באנר העדכון במקור': 'src',
    '217|הרענון מ-controllerchange בלבד': 'src',
    '217|סימן דחיית הבאנר מתמיד': 'src',
    '120|רישום כשלי כתיבה': 'src',
    '65|חלון חם במכשיר': 'src',
    '183|מסך שינוי סיסמה עצמי': 'src',
    '219|מטמון-CDN מראש עם ריפוי עצמי': 'src',
...
export const ROWS = [32, 47, 49, 51, 60, 95, 58, 179, 113, 157, 63, 25, 68, 28, 37, 41];
...
const MATRIX = [
  ...
  { row: 219, name: 'מטמון-CDN מראש עם ריפוי עצמי',
  ...
  { row: 219, name: 'מודול ה-service worker',
...
/*  ⭐ סבב 52 — נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 218, name: 'בדיקת עדכון תקופתית ל-service worker',
  ...
  { row: 217, name: 'מיכל באנר העדכון במקור',
  ...
  { row: 217, name: 'הרענון מ-controllerchange בלבד',
    probe: () => swReloadGaps().length === 0 },
  { row: 217, name: 'סימן דחיית הבאנר מתמיד',
    probe: () => swDismissGaps().length === 0 },
  { row: 217, name: 'עדכון אוטומטי — בדיקה מחזורית',
...
const GATES = {
  ...
  214: { claims: { test_mignames: ['[mig-pattern]', '[mig-seq]', '[mig-file-no-entry]',
  ...
  211: { claim: 'ט. ערך נגזר שהתיישן' },
  213: { claim: 'ח. הגדרה שהוחלפה' },
  212: { claim: 'ד. רשימת-היתר' },
  215: { manual: 'מצב הענפים המרוחקים אינו נראה מעותק העבודה' },
