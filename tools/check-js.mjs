 ...
 *  שערים לבדם היו 70% מזמן הסט. ⚠️ והסיכון שההיפוך פותח — «שכחתי את הדגל
...
const BUDGET_EXEMPT = {
   ...
   *  כולם מתחת לעשירית מהתקרה: ⭐ מה שחורג הוא המוטציות ובדיקות השלמות,
   *  ⛔ ולא גוף השער. ⚠️ והנימוק נושא את שני המספרים — ⛔ נימוק שאינו
   *  מבחין בין הרמות מתאר תקרה שאינה זו שנחצתה. */
  ...
  'test_matrix.mjs':    'הופך תא בטבלה ומריץ את check-capabilities על עותק ' +
                        ...
                        'ברמה המלאה בלבד — נמדד 38.1–69.1 שניות לבדו, ' +
                        '⭐ ו-56–65 מ״ש במהירה',
  ...
  /*  ⛔ `test_rulesdocs` **נשאר** (סבב 92) — ⚠️ שלוש הרצות לבדו בכל ריפו
   *  ברמה המלאה נמדדו 11.1–11.7 · 9.4–9.7 · 10.1–10.5 · 8.8–9.1 שניות:
   *  ⭐ שניים מהארבעה חוצים את התקרה ושניים לא, ⛔ **על אותו קוד בדיוק** —
   *  ⚠️ תנודה של פי 1.3 באותה מכונה, ⛔ והסרה כאן הייתה מייצרת שער שנופל
   *  אקראית. ⭐ וברמה המהירה הוא 107–138 מ״ש, ⛔ כלומר אינו חריג בה כלל. */
  'test_rulesdocs.mjs': 'מריץ 37 קריאות רתמה — 21 ריצות פנימיות · 12 ' +
                        'check-comments · 4 check-capabilities, ⛔ כל אחת שער ' +
                        'אמיתי בתהליך נפרד; ⛔ חורג ברמה המלאה בלבד — נמדד ' +
                        '8.8–11.7 שניות לבדו, ⭐ ו-107–138 מ״ש במהירה',
};
