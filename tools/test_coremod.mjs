...
const APP = {
   ...
   *  ⛔ והוא מוצר ⛔ ולא תשתית. */
  /*  ⚠️ **וההיעדר מוצהר ריק** ⛔ ואינו נשמט — ⭐ אין כאן הגדרה תשתיתית
   *  שיושבת מחוץ לבלוק חתום. */
  coreAllow: {},
  ...
  cssStrings: {
    ...
    _lkStyle:
      'בונה את כללי מסך הנעילה בזמן ריצה — ⛔ הוא במודול המשותף, ⚠️ וזהותו נמדדת ב-`sha256`',
  },
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
 ...
 *  רשימה שנייה בבודק. */
export const ROWS = [18, 19, 59, 138, 207];
