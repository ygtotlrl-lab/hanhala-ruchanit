...
const APP = {
  ...
  actMap: 'DOM_ACTIONS',
  gapRows: [104, 108, 124, 125, 126, 130, 131, 134, 140],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    144: (c) => c.hasCode(/YS_PASS_ITER\s*=\s*100000\b/)
    ...
    143: (c) => !!c.fnBody('ysUsersCacheSave')
    ...
    142: (c) => !!c.fnBody('changeMyPassword')
...
export const ROWS = [37, 41, 42, 44, 40, 52, 74, 47, 135, 84];
