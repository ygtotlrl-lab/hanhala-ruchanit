...
/*  ⛔ ההיקף נחתך במודול אחד (סבב 139) — ⚠️ שער שמודד טענה בתוך גוף או
...
const APP = {
  ...
  kvMeta: { table: 'hr_settings_meta', why: '' },
   ...
   *  נשמט: ⭐ שדה חסר נקרא «לא נשאל», וריק נקרא «נמדד ואין». */
  /*  ⛔ בוני הצריבה (סבב 148) — ⚠️ **מה נכנס**: שם הפונקציה שבונה פלט
  ...
  rasterBuilders: {},
  inlineColorAllow: {},
  /*  ⛔ נקודות השבירה שאין להן מה להשתנות בהן (סבב 155) — ⚠️ **מה
  ...
  bpNoRule: {
    360: 'הבסיס עצמו נכתב לרוחב הטלפון הצר — ⚠️ ומה שמתחת לנקודה הראשונה הוא ברירת המחדל: ⭐ ואין בה מה להשתנות',
    480: 'הטלפון הרחב מציג את אותה עמודה יחידה — ⚠️ וההרחבה הראשונה היא סרגל הכותרת בנקודה שמעל: ⭐ ואין כאן מה להשתנות',
  },
  /*  ⛔ אסימוני המוצר של האפליקציה הזו (סבב 139) — ⚠️ **מה נכנס**: שם
   ...
   *  רשומה ⛔ ולא לסחיפה. */
  appTokens: {
    '--shadow-brand': 'הצל הצבוע של תפריט החיפוש הנפתח — מילוי הצל נגזר מגוון הזהות, ותפריט כזה אינו קיים בשאר',
    '--shadow-brand-soft': 'טבעת המיקוד שסביב שדה החיפוש — דרגה שנייה לאותו צל, והיא טבעת ולא צל הרמה',
    '--at-a': 'גוון מצב הנוכחות «אחר» — מסך הנוכחות קיים בהנהלה בלבד',
    '--at-ak': 'גוון מצב הנוכחות «אישור כניסה» — מסך הנוכחות קיים בהנהלה בלבד',
    '--at-ap': 'גוון מצב הנוכחות «אישור יציאה» — מסך הנוכחות קיים בהנהלה בלבד',
    '--at-e': 'גוון מצב הנוכחות «איחור» — מסך הנוכחות קיים בהנהלה בלבד',
    '--at-l': 'גוון מצב הנוכחות «יציאה» — מסך הנוכחות קיים בהנהלה בלבד',
    '--at-p': 'גוון מצב הנוכחות «נוכח» — מסך הנוכחות קיים בהנהלה בלבד',
    '--at-x': 'גוון מצב הנוכחות «נעדר» — מסך הנוכחות קיים בהנהלה בלבד',
    '--bad-line': 'קו הגבול של אזור הכישלון — גבול הוא תפקיד שלישי לצד הדיו והמשטח',
    '--brand-edge': 'קו הגבול של סרגל הזהות — גבול הוא תפקיד שלישי לצד הדיו והמשטח',
    '--brand-wash': 'שטיפת הזהות מאחורי הסרגל העליון — מוצר ולא תשתית',
    '--info': 'דיו ההודעה המסבירה — הודעה שאינה מצב, ולכן אינה במשפחת המצב',
    '--info-soft': 'המילוי שמתחת לדיו ההודעה — משטח ולא דיו, ומוצר ולא תשתית',
    '--navy-fill': 'המילוי הכחול העמוק של הסרגל, ו-`--brand` נגזר ממנו — מוצר ולא תשתית',
    '--navy-ink': 'דיו הכחול העמוק — תפקיד שני לאותו גוון, ולכן אסימון נפרד',
    '--navy-2': 'דרגת ההבהרה של הכחול העמוק לכותרות — מוצר ולא תשתית',
    '--navy-3': 'דרגת ההכהיה של הכחול העמוק למסגרות — מוצר ולא תשתית',
    '--ok-line': 'קו הגבול של אזור ההצלחה — גבול הוא תפקיד שלישי לצד הדיו והמשטח',
    '--shadow-lg': 'הצל העמוק של המודאל — דרגה שנייה למושג הצל, ומוצר ולא תשתית',
    '--warn-line': 'קו הגבול של אזור האזהרה — גבול הוא תפקיד שלישי לצד הדיו והמשטח',
  },
  skipCaps: ['bchartcss', 'bchart'],
  ...
  saveDirect: {
    saveStudents: 'שכבת ההתמדה — ⛔ כותבת את המצבה ונקראת מ-13 מסלולים: ⚠️ רובם אינם לחיצת שמירה',
    saveUserOrder: 'סדר המשתמשים — ⛔ נקראת מגרירה ולא מכפתור: ⚠️ טוסט על כל גרירה הוא רעש',
    saveUser: 'כתיבה שדורשת רשת — ⛔ ממתינה לענן באמצע הפונקציה, ⚠️ ושתי הודעותיה נבדלות בסיווג: ⭐ הצינור נושא הודעה אחת',
    savePerms: 'כתיבה שדורשת רשת — ⛔ הכשל שלה נושא את הודעת השרת: ⚠️ והצינור היה בולע אותה בהודעה אחת',
    saveAbsenceReasons: 'הטוסט קודם להמתנה בכוונה — ⛔ הכתיבה המקומית סינכרונית והרשת אחריה: ⚠️ והצינור מודיע רק אחרי שהכל נגמר',
  },
  ...
  cdnLibs: [
    ...
    { url: 'https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.3.11/pdfmake.min.js',
      ver: '0.3.11', sym: 'pdfMake' },
    { url: 'https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.3.11/vfs_fonts.js',
      ver: '0.3.11', sym: 'pdfMake',
      why: 'מערכת הקבצים הווירטואלית של `Roboto` — ⛔ אין לה סמל משלה: ⚠️ היא הגופן שאליו נופל-חזרה רישום הגופן העברי, ⭐ ובלעדיה הדוח יוצא בלי גופן כלל' },
  ...
  /*  ⛔ שם מפת מטפלי ה-`data-act` (סבב 89) — ⚠️ השם נבדל ביניהן
   *  והמנגנון אחד: ⭐ מאזין יחיד ב-`document` שמנתב לפי המפה. */
  actMap: 'DOM_ACTIONS',
  /*  ⛔ מה שכתיבתו מחליפה הקשר — ⚠️ כאן זה המשתמש המחובר: ⭐ המנגנון
   *  משותף ⛔ והנלכד נבדל, ⚠️ ולכן ההצהרה פרטית והשער אחד. */
  ...
  writeActs: ['login', 'user-toggle', 'user-save', 'my-pass-save',
               'perms-save', 'switch-confirm', 'student-status-save', 'student-save'],
  writeActsWhy: '',
  /*  ⛔ **איך כל שער סורק את המקור** (סבב 111) — ⚠️ `whiten` למי שמחפש
  ...
  scanKind: {
    ...
    'test_kvmeta': 'raw — מודד שמות מפתחות `kv` — כולם מחרוזות',
    ...
    'test_users_patch': 'raw — מריץ את מראת המשתמשים בארגז חול',
  ...
  gapRows: [229, 145, 149, 173, 67, 158, 111],
  ...
  listAdds: ['saveStudentStatus', 'saveAbsenceReasons', 'atSaveSettingsCfg', 'hrSaveSettingsCfg'],
  ...
  cfgReadFn: 'hrCfgGet',
  cfgKeys: ['absence_reasons', 'approvals', 'attend_cfg', 'attend_treats',
            'perms', 'reasons', 'sleep_cfg', 'sleep_treats'],
  ...
  inlineErrAllow: {
    ...
    'mp-err': 'הודעת שינוי הסיסמה העצמי — ⛔ צמודה לשלושת השדות, ⚠️ והיא מה שאומר איזה מהם נדחה',
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    196: (c) => c.hasCode(/HR_PASS_ITER\s*=\s*100000\b/)
    ...
    195: (c) => !!c.fnBody('hrUsersCacheSave')
    ...
    156: (c) => !/hrCfgSet\('(?:hr_students|hr_sessions|hr_sleep_sessions)'/.test(c.src)
          /*  ⚠️ נמדד על המקור ⛔ ולא על הקוד המולבן — ⭐ שם הטבלה הוא
           *  מחרוזת, ⛔ וההלבנה מרוקנת אותה. */
          && /await pushTable\('hr_sessions',data\)/.test(c.src)
          && /await pushTable\('hr_students_rows', mergedSt\)/.test(c.src),
    ...
    192: (c) => !!c.fnBody('changeMyPassword')
  ...
  gateKind: {
    ...
    'test_roles':         'behavior — מריץ את עצמו על עותק מוטט, והטענה היא שהשער האמיתי נופל',
  ...
  /*  ⛔ מראת המשתמשים (סבב 113) — ⚠️ **מה נכנס**: שם המפתח, המסנן ושני
   *  נתיבי הכתיבה. ⛔ **ומה מפיל**: מפתח שאינו `<קידומת>_mirror_users`,
   *  נתיב שאינו עובר במסנן, ⛔ ועמודת סוד בגופו. ⭐ **ולמה היא קיימת**:
   *  שלוש אפליקציות החזיקו את אותו מנגנון בשלושה שמות. */
  ...
  migrateKeep: {
    migratePrefixKeys: 'הגירת התחילית מ-`ys_` ל-`hr_` (סבב 148) — ⚠️ התור שלא נדחף וזהות המכשיר נושאים במכשיר שלא נטען מאז את השם הישן, ⛔ ולתור אין מקור שני בענן: ⭐ הסרתה מאבדת אותו לנצח',
  },
  mirrorTables: ['hr_sessions', 'hr_marks', 'hr_sleep_sessions', 'hr_sleep_marks',
  ...
  flatKeys: {
    hr_sw_dismissed: 'סימן דחיית באנר העדכון — נושא את שם המטמון שנדחה, ואינו בענן כלל',
    hr_attend_treats:   'שורת הגדרות — רשימת הטיפולים של הנוכחות',
    hr_sleep_treats:    'שורת הגדרות — רשימת הטיפולים של השינה',
    hr_settings_meta:   'מפת חותמות פר-מפתח הגדרות — מטא ולא נתון',
    hr_user_order:      'סדר תצוגה מקומי — אינו בענן כלל',
    hr_perms_cache:     'מטמון ההרשאות — מסלול הכניסה האופליין ולא מטמון מהירות',
    hr_offline_queue:   'תור יוצא מקומי — אינו בענן, והוא מחסום הפינוי',
   ...
   *  פתוח. ⚠️ ו-`junior` היא דרגת הביניים של מטריצת ההרשאות — ⛔ היא
   *  קיימת כאן בלבד, ⭐ ואין ליישר אותה בכוח. */
   ...
   *  ויש לו אתר בקוד. ⭐ **וכאן ריק**: מטריצת ההרשאות מכירה את שלוש
   *  הדרגות, ⛔ ולכולן יש קוראים. */
  rolesUnused: [],
  authUser: 'AUTH.user',
  /*  ⛔ אתר השוואה שאינו בבלוק המשותף (סבב 113) — ⚠️ **מה נכנס**: שם
   ...
   *  להיכשל. */
  /*  ⭐ סבב 125 — ⛔ מה נכנס: שם השדה כפי שהוא במקור, `id` ובהיעדרו
  ...
  enterFields: ['auth-user', 'auth-pass', 'switch-pass', 'um-name', 'um-username',
                'um-pass', 'mp-cur', 'mp-new', 'mp-new2', 'st-name', 'st-cycle',
  ...
  ksaveActs: ['login', 'rpt-load', 'absence-reasons-save', 'at-settings-save', 'sl-settings-save',
              'perms-save', 'switch-confirm', 'user-save', 'my-pass-save',
  ...
  keydownExempt: [
    ...
    { site: "LK_EVENTS  = ['touchstart', 'click', 'keydown', 'scroll']",
      why: 'מדידת חוסר-פעילות לנעילה — אינה מסלול שמירה' },
  ],
  probeInput: {
    '92|המשוב בלחיצה נקבע ולא נירש': 'src',
    '101|חותמת רעננות נכשלת סגור': 'src',
    '88|`Enter` שומר בכל שדה עריכה': 'src',
    '89|מאזין אחד, בהאצלה מ-`document`': 'src',
    '94|כפתור שכותב מושבת בזמן הכתיבה': 'src',
    '192|מבנה טופס הכניסה': 'src',
    '158|שם נגזר אינו נשמר ברשומה': 'src',
    '40|שער מריץ את כל טענותיו': 'tools',
    '100|שכבת המראה': 'src',
    '214|הגירה מקומית שהושלמה': 'mixed',
    '194|מראת המשתמשים': 'src',
    '193|מודל ההרשאות': 'src',
    '28|שער סורק קוד מולבן': 'tools',
    '28|ההלבנה שומרת על מספרי השורות': 'mixed',
    '174|הקשר נלכד בכניסה לפונקציה': 'src',
    '104|פריסה במסכי טלפון וטאבלט': 'src',
    '105|ערכת נושא — בהיר וכהה': 'src',
    '107|סולם אחד לגודל, לריווח ולרדיוס': 'src',
    '108|אין סגנון מוטבע': 'src',
    '111|גרף נבנה מ-CSS ולא מספרייה': 'src',
    '208|הערה שמתארת מצב שחלף': 'mixed',
    '215|שאילתת `@media` מתה': 'src',
    '130|ספרייה חיצונית — גרסה מוצהרת': 'src',
    '131|ייצוא והנפקה — דרך מוצהרת': 'src',
    '112|המסמך מתפרסר נקי': 'src',
    '113|לוג מסלול — תג ורמה': 'src',
    '83|מיכל המודאל ילד ישיר של `body`': 'src',
    '126|פונקציה משותפת אינה יוצאת בשקט': 'src',
    '176|הגיבוי שלם ומעומד': 'src',
    '79|פעולה מגיבה מיד': 'src',
    '80|משיכה מסוננת בשרת': 'src',
    '144|דגימת-יתר במחולל': 'tools',
    '196|`PBKDF2` — פרמטרים': 'src',
    '162|`migrations/` — תוכן': 'src',
    '163|`migrations/` — כמות': 'src',
    '184|מיזוג מכל — מפה ומערך': 'src',
    '185|ברירת מחדל אינה ממוזגת': 'src',
    '186|רשימה אינה נושאת פריט כפול': 'src',
    '177|`sh_backup` — טבלת הגיבוי': 'src',
    '26|שער אינו מקליד מספר שורה': 'tools',
    '32|שער ממתין לתנאי ולא לשעון': 'tools',
    '200|סודות אינם עוזבים את המכשיר': 'src',
    '171|דפוס `upsert` — onConflict מוכרז': 'src',
    '198|טביעה חסרה מושלמת אוטומטית': 'src',
    '198|כניסה אופליין': 'src',
    '155|עריכת נתונים אופליין': 'src',
    '181|מחיקה רכה בלבד — אין `DELETE` פיזי': 'src',
    '199|סיסמאות בענן — אין מסלול שכותב או קורא טקסט גלוי': 'src',
    '77|אובייקט יקר נבנה פעם אחת': 'src',
    '78|מסך מציג מיד ומרענן ברקע': 'src',
    '148|האפליקציה ניתנת להתקנה מכרום': 'src',
    '205|דגלי מעבר — אין דגל דלוק': 'src',
    '85|טיפול באירועים — דלגציה ממאזין אחד': 'src',
    '195|נתיב עדכון חלקי למראת המשתמשים': 'src',
    '99|פינוי אוטומטי': 'src',
    '99|אופק הפינוי נוקה מהסנכרון': 'src',
    '188|אימות פינוי מול הענן': 'src',
    '149|שיתוף קבצים': 'src',
    '132|מעטפת APK (WebView)': 'src',
    '135|אין נכסים מוטבעים': 'src',
    '153|מפתח חתימה קבוע': 'src',
    '159|מקור אמת יחיד לסכימה': 'src',
    '160|קובץ התקנה מלא': 'src',
    '63|גיבוי יומי אוטומטי': 'src',
    '63|יומן פעולות': 'src',
    '156|נתונים בטבלאות מובנות': 'src',
    '14|בודקים — קיום': 'src',
    '15|בודקים — משימה מוצהרת': 'tools',
    '86|דפוס הודעת שגיאה יחיד': 'src',
    '95|`toast` — חתימה, גוף ומחלקות': 'src',
    '95|סיווג ההודעה נגזר מהמסלול': 'src',
    '228|מיכל באנר העדכון במקור': 'src',
    '228|הרענון מ-controllerchange בלבד': 'src',
    '228|סימן דחיית הבאנר מתמיד': 'src',
    '127|רישום כשלי כתיבה': 'src',
    '64|חלון חם במכשיר': 'src',
    '192|מסך שינוי סיסמה עצמי': 'src',
    '230|מטמון-CDN מראש עם ריפוי עצמי': 'src',
    '65|מנוע מיזוג — ⏳ שובר שוויון': 'src',
    '198|חסימת משתמש מושבת בכניסה אופליין': 'src',
    '66|מודול מזהי רשומות': 'src',
    '66|מזהה אינו מומר למספר': 'src',
    '68|מזהה מכשיר': 'src',
    '65|ליבת מיזוג משותפת': 'src',
    '132|מעטפת WebView חתומה': 'tools',
    '198|אימות מול טביעה בענן': 'mixed',
    '151|בניית APK אחידה עם שער חתימה': 'src',
    '230|מודול ה-service worker': 'src',
    '69|ניסיון חוזר בתור הסנכרון': 'src',
    '70|מנגנון משיכה אחיד': 'src',
    '73|נעילת חוסר-פעילות': 'src',
    '74|מודל הסשן — בזיכרון בלבד': 'src',
    '229|בדיקת עדכון תקופתית ל-service worker': 'src',
    '102|פסק זמן אחיד לקריאות רשת': 'src',
    '103|מאזיני מצב רשת': 'src',
    '180|גריעת tombstones לפי גיל': 'src',
    '228|עדכון אוטומטי — בדיקה מחזורית': 'src',
    '149|גשר שיתוף': 'src',
    '75|העברת מזהה ל-DOM': 'src',
    '76|מיון אחד לכל התצוגות': 'src',
    '81|ייצוא — שני דפוסים מוצהרים': 'src',
    '141|שכבת אייקונים': 'src',
    '189|שכבת קלט אחידה': 'src',
    '189|קריאת ערך מספרי עוברת ב-readNum': 'src',
    '82|שכבת המודאל': 'src',
    '192|שכבת כניסה מלאה': 'src',
  },
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
...
export const ROWS = [36, 34, 48, 49, 58, 98, 56, 187, 118, 165, 62, 27, 67, 30, 38, 42, 203, 210];
...
const CAPS = {
  ...
  toastcss: {
    ...
    block: { sha: 'c9922e38e9692030', lines: 14,
             css: true,
             start: '/* ═══ שכבת הטוסט — מודול משותף (סבב 87ב)',
             end:   '/* ═══ סוף CSS שכבת הטוסט' },
  },
  /*  ⭐ סבב 137 — גרף העמודות. ⚠️ שני בלוקים: ⛔ הכללים ב-`<style>`,
  ...
  bchartcss: {
    ...
    block: { sha: 'dd2b990db1b02a47', lines: 18,
             css: true,
  ...
  bchart: {
    ...
    docRows: ['גרף נבנה מ-CSS ולא מספרייה'],
    block: { sha: '3e2e7c10cb1ce496', lines: 51,
             start: '/* ═══ גרף העמודות — מודול משותף (סבב 137)',
             end:   '/* ═══════════════ סוף מודול גרף העמודות' },
  },
  /*  ⭐ סבב 138 — סולמות הגודל, הריווח והרדיוס. ⚠️ **מה נכנס**: שלוש
  ...
  scales: {
    ...
    block: { sha: '8693c2c1cbfeb479', lines: 40,
             css: true,
  ...
  msgs: {
    ...
    block: { sha: 'a24432448bcd55b8', lines: 49,
  ...
  rowswin: {
    ...
    block: { sha: '025a094e9023a133', lines: 41,
  ...
  storage: {
    ...
    block: { sha: '82ed63cd2667ba7f', lines: 591,
  ...
  /*  ⭐ סבב 135 — כפתור עסוק והשומר שבניתוב. ⚠️ שני מימושים חיו זה לצד
  ...
  savepipe: {
    ...
    block: { sha: '2fb6617fcd95b9b4', lines: 40,
  ...
  pending: {
    ...
    block: { sha: '2d4b8431af31a3f9', lines: 284,
  ...
  backup: {
    ...
    block: { sha: 'daa0889af6ae2ab3', lines: 303,
  ...
  mergecore: {
    ...
    block: { file: 'core/sync.js', sha: '182161a5d0eab10b', lines: 76,
  ...
  tomb: {
    ...
    docRows: ['`tombstones`'],
    block: { file: 'core/sync.js', sha: 'a190e13c0fbe948e', lines: 65,
  ...
  devid: {
    ...
    block: { sha: 'd3223772e544bb30', lines: 20,
  ...
  ids: {
    ...
    block: { file: 'core/sync.js', sha: '4b9b00d46e4cf207', lines: 47,
  ...
  neterr: {
    ...
    block: { sha: 'ac1e05546f0ece88', lines: 31,
  ...
  retry: {
    ...
    block: { sha: '35a39f904eaa9813', lines: 70,
  ...
  ctxguard: {
    ...
    block: { file: 'core/sync.js', sha: '82022151c3b0cc20', lines: 24,
  ...
  pull: {
    ...
    block: { sha: '70369b177ab1caa0', lines: 79,
             start: '/* ═══ מנגנון המשיכה — מודול משותף (סבב 51)',
             end:   '/* ═══════════════ סוף מנגנון המשיכה' },
    hooks: [{ fn: 'plBoot', at: 'boot' }],
  },
  /*  ⭐ סבב 102 — שכבת הדחיפה. ⛔ היא יושבת אחרי מנגנון המשיכה מפני
  ...
  push: {
    ...
    block: { sha: 'f95faf1933bc7b0c', lines: 114,
             start: '/* ═══ שכבת הדחיפה — מודול משותף (סבב 102)',
             end:   '/* ═══════════════ סוף מודול שכבת הדחיפה' },
  },
  /*  ⭐ סבב 103 — כתיבת משתמש. ⛔ הוא נעדר ב-yoman-avoda, שאין בה מסך
  ...
  writeUser: {
    ...
    block: { sha: 'de7ecb397dd1efab', lines: 45,
             start: '/* ═══ כתיבת משתמש — מודול משותף (סבב 103)',
  ...
  lock: {
    ...
    block: { sha: '54e30d860862816a', lines: 105,
  ...
  uihelp: {
    ...
    block: { sha: '5ffef16ec1c2dff6', lines: 123,
   ...
   *  ⚠️ ושניים מהם נבדלו. */
  /*  ⭐ סבב 104 — קריאת ערך מספרי משדה. ⚠️ אין לו `hooks`: הוא נקרא מכל
   *  אתר שקורא שדה, ⛔ והחיווט נמדד בשורת «שדה מספרי» ולא כאן. */
  readnum: {
    name: 'מודול קריאת ערך מספרי',
    docRows: ['שדה מספרי'],
    block: { file: 'core/util.js', sha: 'f8b233ccafc4d007', lines: 21,
             start: '/* ═══ קריאת ערך מספרי — מודול משותף (סבב 104)',
             end:   '/* ═══════════════ סוף מודול קריאת ערך מספרי' },
  },
  uniq: {
    name: 'מודול כיווץ רשימת ערכים',
    docRows: ['רשימה אינה נושאת פריט כפול'],
    block: { file: 'core/util.js', sha: '1315fa4b4cf7d0ce', lines: 28,
             start: '/* ═══ כיווץ רשימת ערכים — מודול משותף (סבב 101)',
             end:   '/* ═══════════════ סוף מודול כיווץ רשימת ערכים' },
  },
  /*  ⭐ סבב 125 — ⛔ אין לו `hooks`: הוא נרשם בעליית הקובץ ואין לו
  ...
  keysave: {
    ...
    block: { sha: '080420b912866eb5', lines: 34,
  ...
  kvval: {
    ...
    block: { sha: '5526338f241b404d', lines: 22,
  ...
  swreg: {
    ...
    block: { sha: '9e8c84e288363cba', lines: 108,
  ...
  swcore: {
    ...
    docRows: ['ליבת `sw.js`'],
    block: { file: 'sw.js', sha: '278e558ef959d14c', lines: 250,
...
/*  ⛔ כל בלוק חתום מוצהר בשורה בטבלה (סבב 106) — ⚠️ החתימה מוכיחה שהבלוק
...
/*  ⛔ שם שורה נפתח בטקסט (סבב 106) — ⚠️ שלושת הסימנים הם ניסוח ⛔ ולא שם:
...
/*  ⛔ סדר הפנים של כל קטגוריה (סבב 106) — ⚠️ הטבלה הצהירה **רציפות
...
const CAT_ORDER = [
  ...
  { g: 'ג', phases: [{ p: 'מבנה', w: ['עמודת התקן', 'מספור הטבלה'] },
                     ...
                     { p: 'סימון', w: ['הסימון', 'נרשם ככזה', 'כל קלט נופל'] }] },
...
/*  ⛔ הבודק מפוצל לשערים לפי נושא (סבב 137) — ⚠️ **מה נכנס**: שם שער ⟵
...
let _OVER = null;
/*  ⛔ שלוש משפחות קלט, והחלוקה ממצה (סבב 113) — ⚠️ **תיעוד** הוא הטבלה
...
/*  ⛔ הקלט שכל בדיקה קוראת נרשם בזמן ריצה (סבב 113) — ⚠️ ההצהרה נסרקת
...
/*  ⛔ תוצאת בדיקה נשמרת בין הרצות (סבב 113) — ⚠️ המפה נכתבת **בהרצה
...
/*  ⛔ סורק שאינו קורא את התיעוד נמדד פעם אחת לכל מקור (סבב 168) —
...
function memoSrc(ns, fn) {
  const key = process.cwd() + '\0' + (process.env.GATE_MUT || '') + '\0' +
    (_OVER ? Object.keys(_OVER).filter((k) => inputKind(k) !== 'doc').sort()
...
/*  ⛔ סולם נקודות השבירה נמדד בכיסוי ⛔ ולא בכיוון בלבד (סבב 155) —
...
/*  ⛔ מונה הטענות של הריצה האחרונה (סבב 137) — ⚠️ שערי החלקים קוראים
...
_OVER = over || null;
/*  ⛔ `changed` הוא משפחות הקלט שהשתנו מאז ההרצה הנקייה (סבב 113) —
...
/*  ⛔ החלק שהריצה הזו מודדת (סבב 137) — ⚠️ שם שאינו במרשם זורק, ⛔ ואינו
...
const FLOOR = { shared: 91, app: 9, appWhy: 'כניסה — סשן · נעילה · הרשאות · כתיבת משתמש · שכבת המראה; ומעליהם מנוע התאריך העברי' };
/* ⚠️ סוף פר-אפליקציה */
...
/*  ⛔ טענות הליבה רצות בשער הליבה בלבד (סבב 137) — ⚠️ הבודק מפוצל
 ...
 *  שקיים במקום הלא-נכון מפיל. */
{
  ...
  if (bg.length)
    ...
    cpass(`תבנית באנר הבלוק — כולם נושאים «— מודול משותף (סבב N)» ` +
...
/*  ⛔ מפתח הגדרה שהקוד מבקש (סבב 86) — ⚠️ הנימוק נמדד: `hr_sleep_treats`
...
/*  ⛔ האופק סוגר את עצמו (סבב 136) — ⚠️ **מה נכנס**: `lsHorizonRelease`
...
/*  ⛔ אתרי המרה של **ביטוי־זהות** למספר (סבב 104) — ⚠️ הסריקה על קוד
...
/*  ⛔ אתרי קריאה **גולמית** של ערך שדה (סבב 104) — ⚠️ המרה ישירה על
...
function gateSealGaps() {
  ...
  for (const f of files) {
    ...
    /*  ⛔ דילוג הוא הכרעה ⛔ ולא טענה שלא רצה (סבב 148) — ⚠️ **מה נכנס**:
  ...
  /*  ⛔ הטווח והנימוק בהצהרה **אחת** (סבב 121) — ⚠️ שתי רשימות לאותו
...
/*  ⛔ תקרת גודל לשער (סבב 137) — ⚠️ **מה נכנס**: מספר השורות של כל קובץ
...
/*  ⛔ דפוס שאינו יכול להיכשל (סבב 137) — ⚠️ **מה נכנס**: קוד השערים אחרי
...
function anchorGaps() {
  ...
  for (const f of files) {
    ...
    for (const needle of [DEAD_TAIL, DEAD_HEAD]) {
      ...
      while (i >= 0) {
        out.push(`דפוס שמתאים תמיד: tools/${f}:${t.slice(0, i).split('\n').length} ` +
...
/*  ⛔ probe שבודק נוכחות ולא מיקום (סבב 138) — ⚠️ **מה נכנס**: כל רשומה
...
function presenceGaps() {
  ...
  /*  ⛔ הגוף נחתך במודול ההיקף (סבב 139) — ⚠️ מונה סוגריים שאינו מדלג
...
/*  ⛔ סגנון מוטבע (סבב 137) — ⚠️ **מה נכנס**: כל תגית שנושאת `style="…"`
...
/*  ⛔ הסריקה תופסת גם גרשיים בודדים וגם גרש נמלט (סבב 138) — ⚠️ סורק
...
/*  ⛔ האזורים שהסגנון בהם מוטבע בכוונה (סבב 138) — ⚠️ **מה נכנס**: שם
...
function inlineStyleGaps() {
  ...
  /*  ⛔ ובונה שאינו צורב מפיל (סבב 148) — ⚠️ ההיתר קיים מפני שהפלט נצרב,
...
/*  ⛔ וכל ליטרל באזור מוצלב לאסימון (סבב 138) — ⚠️ הנימוק המדוד: שבעת
...
/*  ⛔ סולם אחד לגודל, לריווח ולרדיוס (סבב 138) — ⚠️ **מה נכנס**: כל הצהרה
...
/*  ⛔ גרף נבנה מ-CSS ולא מספרייה (סבב 137) — ⚠️ **מה נכנס**: הבונה
...
/*  ⛔ פס יחיד ופס בסדרה הם רכיב אחד (סבב 139) — ⚠️ **מה נכנס**: גוף
...
/*  ⛔ קבוע שהוגדר ואין לו קורא (סבב 148) — ⚠️ **מה נכנס**: כל הצהרת
...
function constNoReaderGaps() {
  ...
  for (const m of code.matchAll(/(?:^|\n)\s*(?:var|const|let)\s+([A-Za-z_$][\w$]*)\s*=/g)) {
    ...
    out.push(name + ' (שורה ' + (code.slice(0, at).split('\n').length) + ')');
  }
  return out;
}
...
function localSortSites() {
  ...
  const out = [];
  /*  ⛔ האתרים נאספים ב-`matchAll` (סבב 139) — ⚠️ סמן שרץ ב-`indexOf`
...
/*  ⛔ מסלול לחיצה שממתין בלי חיווי (סבב 89) — ⚠️ הטענה אינה «יש `busy`
...
function actGateWrapped() {
  ...
  for (let i = src.indexOf("addEventListener('click'"); i >= 0;
    ...
    /*  ⛔ השומר עבר לבלוק המשותף (סבב 135) — ⚠️ הניתוב מוסר לו את האלמנט
...
function exportWayGaps() {
  /*  ⛔ הנמדד הוא **מספר אתרי הקריאה** (סבב 139) — ⚠️ «הדפוס קיים»
   *  ו«לדפוס יש אתר אחד לפחות» הם אותה טענה, ⭐ והמונה הוא מה שאפשר
   *  להשוות למספר. */
  const cnt = (re) => (code.match(re) || []).length;
  const has = {
    /*  ⛔ אתר קריאה ⛔ ולא הופעת השם (סבב 138) — ⚠️ `html2canvas` מופיע
...
/*  ⛔ קבוע שנכנס למיזוג עם הענן (סבב 121) — ⚠️ **מה נמדד**: קריאה מהדיסק
...
function constSeedSites() {
  ...
  const lineOf = (i) => w.slice(0, i).split('\n').length;
  const out = [];
...
function swDismissGaps() {
  ...
  /*  ⛔ סינון המטמון לפי קידומת המטמון ⛔ ולא לפי קידומת האחסון (סבב 135) —
...
/*  ⛔ ערכת נושא — בהיר וכהה (סבב 97) — ⚠️ המבנה אחד בכולן: בלוק
...
/*  ⛔ כללי באנר העדכון קיימים (סבב 131) — ⚠️ **מה נכנס**: כל כלל שסלקטורו
...
/*  ⛔ צמד `X`/`on-X` נמדד בשני המצבים (סבב 135) — ⚠️ **מה נכנס**: כל אסימון
 ...
 *  ⛔ **והרשימה אינה סגורה על חמישה (סבב 139)** — ⚠️ רשימה סגורה תופסת את
 *  מה שהיה ⛔ ולא את מה שנוסף: ⭐ נמדד ששם שירד בסבב 134 חזר ביומן לצד
 ...
 *  ⛔ **ומפת השמות שפרשו ירדה (סבב 140)** — ⚠️ נמדד ששם שפרש והוגדר
...
/*  ⛔ כפתור שממתין לכתיבה ברשת מושבת (סבב 135) — ⚠️ **מה נכנס**:
...
function topLevelReturn(body) {
  ...
  for (let i = 0; i < body.length; i++) {
    ...
    if (c === '{' || c === '(' || c === '[') { d++; continue; }
    if (c === '}' || c === ')' || c === ']') { d--; continue; }
    /*  ⛔ הגבול נמדד ⛔ ואינו חלופה שמתאימה תמיד (סבב 137) — ⚠️ `|^`
...
/*  ⛔ צינור השמירה (סבב 136) — ⚠️ **מה נכנס**: כל `function save*`
...
/*  ⛔ מאזיני מצב הרשת (סבב 136) — ⚠️ **מה נכנס**: כל מאזין
...
/*  ⛔ צורות ההגדרה הן מה שנסרק (סבב 148) — ⚠️ הנימוק המדוד: הכותב ישב
...
function tokenVocabGaps() {
  ...
  const css = cssText();
  /*  ⛔ הפניה ל-`var()` שאין לה הגדרה (סבב 140) — ⚠️ המאפיין מושמט בשקט,
...
/*  ⛔ אסימון מוצר מוצהר בשמו ובנימוקו (סבב 139) — ⚠️ **מה נכנס**: כל שם
...
/*  ⛔ נימוק שנוקב בנוכחות בלבד (סבב 140) — ⚠️ «אינו בכולן» הוא
...
/*  ⛔ משפחת הרקע (סבב 136) — ⚠️ **מה נכנס**: שלוש רמות בשם
...
function bgFamilyGaps() {
  const out = [];
  /*  ⛔ שלוש הרמות נאכפות באוצר המילים (סבב 139) — ⚠️ שתי בדיקות נוכחות
...
function ctxGuardGaps() {
  ...
  /*  ⛔ צד ז — **הדחיפה המושהית היא מחזור בפני עצמו** (סבב 111) — ⚠️ ההשהיה
...
/*  ⛔ שער סורק קוד מולבן (סבב 111) — ⚠️ ההלבנה הייתה מוזכרת בשורת
...
/*  ⛔ מודל ההרשאות (סבב 113) — ⚠️ **שלוש מדידות יחד**: ⭐ אוצר מילים
...
/*  ⛔ טקסט המיגרציות כולן (סבב 113) — ⚠️ **מה נכנס**: כל קובץ `.sql`
...
function roleModelGaps() {
  ...
  /*  ⛔ ההצהרה נמדדת בקוד **או במיגרציות** (סבב 113) — ⚠️ אפליקציה שאין
  ...
  /*  ⛔ הנמדד הוא **מספר האתרים** (סבב 139) — ⚠️ «השם קיים» ו«לשם יש
  ...
  /*  ⛔ ההודעה שנבדלת (סבב 113) — ⚠️ «אין לך הרשאה» למנהל שחסרה לו
  ...
  /*  ⛔ הדפוס נושא גבול משני הצדדים (סבב 139) — ⚠️ הנקודה שבשם היא
...
/*  ⛔ מראת המשתמשים (סבב 113) — ⚠️ **שלוש מדידות יחד**: ⭐ שם מפתח אחד
...
function userMirrorGaps() {
  ...
  /*  ⛔ הנמדד הוא **מספר הליטרלים** (סבב 139) — ⚠️ «המחרוזת קיימת»
  ...
  if (!san || !fnRange(san)) out.push('אין מסנן מוצהר למראה');
    ...
    /*  ⛔ קפיצה אחת מותרת (סבב 113) — ⚠️ נתיב שקורא לעוטף שקורא למסנן
...
/*  ⛔ שדות העריכה נמדדים על המקור הגולמי (סבב 125) — ⚠️ הטפסים נבנים
...
function listenerSites(text) {
  ...
  for (const m of text.matchAll(/(?<![\w$.])([\w$]+(?:\.[\w$]+)*)\.addEventListener\(\s*([^,]{0,60}?)\s*,/g))
    out.push({ host: m[1], arg: m[2].trim(), line: text.slice(0, m.index).split('\n').length });
  return out;
}
...
function keySaveGaps() {
  ...
  for (const e of APP.enterExempt || []) {
    ...
    /*  ⛔ ההיקף הוא הטופס עצמו (סבב 139) — ⚠️ «יש `<form>` במסמך» מאשר
  ...
  /*  ⛔ ההיקף של הצהרת מאזין הוא חלון האירוע (סבב 139) — ⚠️ «השם קיים
...
const MATRIX = [
  ...
  { row: 174, name: 'הקשר נלכד בכניסה לפונקציה',
  ...
  { row: 104, name: 'פריסה במסכי טלפון וטאבלט',
  ...
  /*  ⛔ אין סגנון מוטבע (סבב 137) — ⚠️ הצד שנסגר הוא **הצבע**: ⭐ ליטרל
  ...
  { row: 108, name: 'אין סגנון מוטבע',
    probe: () => inlineStyleGaps().length === 0 },
  /*  ⛔ סולם אחד לגודל, לריווח ולרדיוס (סבב 138) — ⚠️ הצד שנסגר אחרי
   *  הצבע: ⭐ 482 ערכים מספריים ישבו בסגנון מוטבע, ⛔ וכל אתר בחר מספר
   *  משלו — ⚠️ והדרגות עצמן משותפות לכולן. */
  { row: 107, name: 'סולם אחד לגודל, לריווח ולרדיוס',
    probe: () => scaleGaps().length === 0 },
  /*  ⛔ גרף נבנה מ-CSS ולא מספרייה (סבב 137) — ⚠️ פס אמיתי כבר חי בגיוס
   *  בשורת הפילוח, ⭐ וזה מה שהוכיח שגרף אינו דורש ספרייה. */
  { row: 111, name: 'גרף נבנה מ-CSS ולא מספרייה',
    probe: () => chartGaps().length === 0 },
  { row: 105, name: 'ערכת נושא — בהיר וכהה',
  ...
  { row: 113, name: 'לוג מסלול — תג ורמה',
  ...
  { row: 83, name: 'מיכל המודאל ילד ישיר של `body`',
  ...
  { row: 126, name: 'פונקציה משותפת אינה יוצאת בשקט',
  ...
  { row: 176, name: 'הגיבוי שלם ומעומד',
    probe: () => {
       ...
       *  ⛔ **וההיקף הוא גוף הקריאה** (סבב 139) — ⚠️ בקשת עימוד בכל מקום
  ...
  { row: 173, name: 'החלפת הקשר מאפסת את כל המצב', app: true },
  ...
  { row: 79, name: 'פעולה מגיבה מיד',
    probe: () => actNoFeedback().length === 0 },
  { row: 80, name: 'משיכה מסוננת בשרת', app: true },
  ...
  { row: 144, name: 'דגימת-יתר במחולל',
    probe: () => Number((/^const SS = (\d+);/m.exec(genSrc()) || [])[1]) === GEN_SS },
  { row: 196, name: '`PBKDF2` — פרמטרים', app: true },
  { row: 162, name: '`migrations/` — תוכן',
    probe: () => migContentGaps().length === 0 },
  { row: 163, name: '`migrations/` — כמות',
  ...
  { row: 186, name: 'רשימה אינה נושאת פריט כפול',
  ...
  { row: 177, name: '`sh_backup` — טבלת הגיבוי',
  ...
  { row: 200, name: 'סודות אינם עוזבים את המכשיר',
    probe: () => {
      ...
      /*  ⛔ הנמדד הוא **מספר האתרים** (סבב 139) — ⚠️ הסוד אינו בגוף
  ...
  { row: 171, name: 'דפוס `upsert` — onConflict מוכרז', app: true },
  ...
  { row: 198, name: 'טביעה חסרה מושלמת אוטומטית',
  ...
  { row: 198, name: 'כניסה אופליין',
    probe: () => !!(APP.offlineLoginFn && fnRange(APP.offlineLoginFn)) },
  { row: 155, name: 'עריכת נתונים אופליין',
  ...
  { row: 181, name: 'מחיקה רכה בלבד — אין `DELETE` פיזי',
  ...
  { row: 199, name: 'סיסמאות בענן — אין מסלול שכותב או קורא טקסט גלוי',
    probe: () => {
  ...
  { row: 77, name: 'אובייקט יקר נבנה פעם אחת',
  ...
  { row: 78, name: 'מסך מציג מיד ומרענן ברקע',
  ...
  { row: 195, name: 'נתיב עדכון חלקי למראת המשתמשים', app: true },
  ...
  { row: 99, name: 'אופק הפינוי נוקה מהסנכרון',
  ...
  { row: 188, name: 'אימות פינוי מול הענן',
    probe: () => perKeyWitness() && witnessFed() },
  { row: 149, name: 'שיתוף קבצים',
    probe: () => hasCode(/_androidShareImage|navigator\s*\.\s*share\b/) },
  { row: 132, name: 'מעטפת APK (WebView)',
   ...
   *  שמתיישן בכל שחרור. */
  { row: 135, name: 'אין נכסים מוטבעים',
    probe: () => !hasPath('android/app/src/main/assets/index.html') &&
                 !hasPath('android/app/src/main/assets/sw.js') },
  { row: 153, name: 'מפתח חתימה קבוע',
    probe: () => keystoreFixed() },
  { row: 159, name: 'מקור אמת יחיד לסכימה', probe: () => schemaSingleSource() },
  { row: 160, name: 'קובץ התקנה מלא',       probe: () => schemaIdempotent() },
  { row: 63, name: 'גיבוי יומי אוטומטי',   probe: () => present.backup === true },
  { row: 63, name: 'יומן פעולות',          probe: () => present.log === true },
  { row: 156, name: 'נתונים בטבלאות מובנות', app: true },
  ...
  { row: 86, name: 'דפוס הודעת שגיאה יחיד', probe: () => errPatternSites() === 0 },
  ...
  { row: 95, name: 'סיווג ההודעה נגזר מהמסלול',
    probe: () => toastKindGaps().length === 0 },
  { row: 95, name: '`toast` — חתימה, גוף ומחלקות',
  ...
  { row: 64, name: 'חלון חם במכשיר',
    probe: () => /\benabled\s*:\s*true\b/.test(cfgBlock('HW_CFG')) },
  { row: 192, name: 'מסך שינוי סיסמה עצמי', app: true },
  { row: 192, name: 'מבנה טופס הכניסה',
    probe: () => src.indexOf('<form') < 0 },
  { row: 230, name: 'מטמון-CDN מראש עם ריפוי עצמי',
    probe: () => fileHas('sw.js', /CDN_ASSETS/) && fileHas('sw.js', /ensureCdnCached/) },
  { row: 63, name: 'גיבוי יומי מטבלאות מובנות',
  ...
  { row: 175, name: 'פינוי גיבויים אוטומטי במסד',
   ...
   *  ⛔ ולא `NaN`. */
  { row: 66, name: 'מזהה אינו מומר למספר',
  ...
  { row: 132, name: 'מעטפת WebView חתומה',
  ...
  { row: 198, name: 'אימות מול טביעה בענן',
    probe: () => {
      ...
      if (!m) return false;
      /*  ⛔ אתר קריאה ⛔ ולא הופעת השם (סבב 139) — ⚠️ `callSites` מוצא
  ...
  { row: 151, name: 'בניית APK אחידה עם שער חתימה',
    probe: () => {
  ...
  { row: 230, name: 'מודול ה-service worker',
  ...
  { row: 69, name: 'ניסיון חוזר בתור הסנכרון',
...
/*  ⭐ סבב 52 — נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 74, name: 'מודל הסשן — בזיכרון בלבד',
  ...
  { row: 229, name: 'בדיקת עדכון תקופתית ל-service worker',
    probe: () => hasCode(/\breg\s*\.\s*update\s*\(/) &&
                 ...
                 hasCode(/sbWatch\(/) },
  /*  ⭐ סבב 53 — שלוש שורות תשתית שהיו קיימות בכולן **ולא נמדדו כאן
  ...
  /*  ⛔ שכבת המראה (סבב 114) — ⚠️ הצהרת `MIRROR_CFG` מול `PUSH_TABLES`,
   *  ⭐ ורשימת המפתחות השטוחים משני צדדיה. */
  { row: 40, name: 'שער מריץ את כל טענותיו',
    probe: () => memoSrc('gateSealGaps', gateSealGaps).length === 0 },
  { row: 100, name: 'שכבת המראה', probe: () => mirrorLayerGaps().length === 0 },
  { row: 214, name: 'הגירה מקומית שהושלמה',
    probe: () => localMigrationGaps().length === 0 },
  { row: 102, name: 'פסק זמן אחיד לקריאות רשת',
  ...
  { row: 103, name: 'מאזיני מצב רשת',
    probe: () => hasSrc(/window\.addEventListener\('online'/) &&
                 hasSrc(/window\.addEventListener\('offline'/) },
  /*  ⛔⛔ המנגנון עבר לבלוק חתום וחווט בכולן (סבב 93) — ⚠️ עד כאן הוא חי
   ...
   *  ולא רק מוגדרים. */
  { row: 180, name: 'גריעת tombstones לפי גיל',
    probe: () => {
  ...
  /*  ⛔ המיכל נמדד בתגיות ⛔ ולא בכל הקובץ (סבב 138) — ⚠️ אותה מחרוזת
   *  בתוך מחרוזת JS עברה כתגית, ⭐ והבאנר לא היה במקור כלל. */
  { row: 228, name: 'מיכל באנר העדכון במקור',
    probe: () => /<div id="updater">/.test(markupOnly()) &&
                 /*  ⛔ הנמדד הוא המקור הגולמי (סבב 139) — ⚠️ `'updater'`
  ...
  { row: 228, name: 'הרענון מ-controllerchange בלבד',
    probe: () => swReloadGaps().length === 0 },
  { row: 228, name: 'סימן דחיית הבאנר מתמיד',
    probe: () => swDismissGaps().length === 0 },
  { row: 228, name: 'עדכון אוטומטי — בדיקה מחזורית',
    /*  ⛔ ההיקף הוא גוף `swRegister` (סבב 139) — ⚠️ בדיקה מחזורית שנרשמת
  ...
  { row: 75, name: 'העברת מזהה ל-DOM',
    /*  ⛔ הנמדד הוא **מספר האתרים** (סבב 139) — ⚠️ «הדפוס קיים» מאשר גם
  ...
  { row: 76, name: 'מיון אחד לכל התצוגות',
    /*  ⛔ הגדרת הפונקציה נמדדת בטווחה (סבב 139) — ⚠️ `fnRange` מחזיר את
  ...
  { row: 81, name: 'ייצוא — שני דפוסים מוצהרים',
    probe: () => exportMarkupSites().length === 0 },
  { row: 141, name: 'שכבת אייקונים',
    probe: () => memoByHash('icons', ICON_SIG(), () => iconAudit('.')).length === 0 },
  { row: 189, name: 'שכבת קלט אחידה',
  ...
  { row: 189, name: 'קריאת ערך מספרי עוברת ב-readNum',
...
/* ───────────────────────────────────────────────────────────────────────────
   ...
   ──────────────────────────────────────────────────────────────────────── */
/*  ⛔ הנימוק לטענה שאין לה מוטציה (סבב 167) — ⚠️ **מה נכנס**: מפתח
...
const CLAIM_NO_MUT = {
  ...
  '35|א · כל מפתח נקרא':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '36|לכל אחד שינוי, תווית':
    'המוטציה מריצה את הבודק על עותק ברתמה — ⛔ והתווית נוקבת בשם הבודק שנפל, ⚠️ ולא בשם הטענה',
  '37|שם הטענה שתיפול':
    'המוטציה מריצה את הבודק על עותק ברתמה — ⛔ והתווית נוקבת בשם הבודק שנפל, ⚠️ ולא בשם הטענה',
  '39|א · כל דפוס מוכרז נושא מוטציה':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '41|BUDGET_MS':
    'המוטציה מריצה את הבודק על עותק ברתמה — ⛔ והתווית נוקבת בשם הבודק שנפל, ⚠️ ולא בשם הטענה',
  '42|תקציב זמן לסט':
  ...
  '44|מספרי הבאנר':
    'המוטציה מריצה את הבודק על עותק ברתמה — ⛔ והתווית נוקבת בשם הבודק שנפל, ⚠️ ולא בשם הטענה',
  '49|פתיחת ההערה בטבלה':
    'המוטציה מריצה את הבודק על עותק ברתמה — ⛔ והתווית נוקבת בשם הבודק שנפל, ⚠️ ולא בשם הטענה',
  '50|ז · כל מרשם מוכרז':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '50|ח · מפקד נגזר ואינו מוקלד':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '51|י · מרשם חישוב נושא את המקרה הריק':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '52|ט · probe מודד מימוש':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '54|יא · נימוק ⭕ מונה את מה שאינו נאכף':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '55|תוכן הקבצים הנלווים':
    'המוטציה מריצה את הבודק על עותק ברתמה — ⛔ והתווית נוקבת בשם הבודק שנפל, ⚠️ ולא בשם הטענה',
  '57|א · אין שתי שורות על אותו probe':
  ...
  '72|כתיבת משתמש':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '91|מחלקה משותפת שמצביה נבדלים':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '96|ליטרל עברי באתר הודעה':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '97|ג · פעולה שדורשת רשת':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '109|ליטרל צבע בגיליון':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '109|ערך שאינו דרגה בסולם':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '109|ערך מספרי שאינו נגזר':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '117|[sister-ambig]':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '118|RULE_W':
  ...
  '134|android:theme':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '137|android/app/src/main':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '145|fgDriftMax':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '146|CANON_MANIFEST':
    'המוטציה מריצה את הבודק על עותק ברתמה — ⛔ והתווית נוקבת בשם הבודק שנפל, ⚠️ ולא בשם הטענה',
  '157|ג. כל מפתח שהקוד מבקש':
    'הטענה נמדדת מול המסד החי — ⛔ ומוטציה הייתה כותבת לייצור',
  '161|migrations':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '165|ה. דפוס עמודות אחיד':
    'הטענה נמדדת מול המסד החי — ⛔ ומוטציה הייתה כותבת לייצור',
  '166|ו. טבלה מקבילה':
    'הטענה נמדדת מול המסד החי — ⛔ ומוטציה הייתה כותבת לייצור',
  '167|ב. חתימת סכימה':
  ...
  '170|יג. תוספת-בלבד':
    'הטענה נמדדת מול המסד החי — ⛔ ומוטציה הייתה כותבת לייצור',
  '172|א. חותמת בכל רשומה':
    'הטענה נמדדת מול המסד החי — ⛔ ומוטציה הייתה כותבת לייצור',
  '178|`ya_settings_rishon`':
    'הטענה נמדדת מול המסד החי — ⛔ ומוטציה הייתה כותבת לייצור',
  '179|י. ערך במפתח-ערך':
    'הטענה נמדדת מול המסד החי — ⛔ ומוטציה הייתה כותבת לייצור',
  '179|יא. ערך פגום נבדל':
    'הטענה נמדדת מול המסד החי — ⛔ ומוטציה הייתה כותבת לייצור',
  '187|ג. כל מפתח שהקוד מבקש':
    'הטענה נמדדת מול המסד החי — ⛔ ומוטציה הייתה כותבת לייצור',
  '190|[zero-guard-registry]':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '191|type=password':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '197|pass_salt':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '201|אין `service_role` בקובץ':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '204|[synclog-push]':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '207|[core-allow]':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '210|כל קובץ בעץ מוזכר במקום אחר':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '211|מזהה שנמחק ונשאר לו קורא':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
  '212|[call-arity-registry]':
    'המוטציה שבשער נוקבת במנגנון שהיא שוברת — ⛔ ולא בתווית שמאתרת את הטענה בפלט',
...
const GATES = {
  /*  ⭐ סבב 155 — ⛔ הגרירה עוברת ב-Pointer Events: ⚠️ שתי טענות
   *  טקסטואליות — האירועים והידית — ⭐ ואחת שגוררת בדפדפן אמיתי,
   *  ⛔ בעכבר ובמגע. */
  90: { claims: { test_visual: ['[drag-api]', '[drag-grip]'] } },
  /*  ⭐ סבב 150 — ⛔ אסימון סמנטי ממופה לתפקיד אחד: ⚠️ צבע הזהות מול
   *  `theme_color` שבמניפסט, ⭐ ושלושת אסימוני המצב מול תחום הגוון של שמם. */
  106: { claims: { test_visual: ['[semantic-role]'] } },
  /*  ⭐ סבב 150 — ⛔ מיכל דיאלוג נפתח מעל השכבה שפתחה אותו: ⚠️ הדרגה
   *  בסולם, ⭐ והפעולות שפותחות דיאלוג נגזרות ממפת הפעולות. */
  84: { claims: { test_visual: ['[dialog-layer]', '[dialog-registry]'] } },
  /*  ⭐ סבב 150 — ⛔ מחלקה שמגדירה אסימון נקראת באתר שבו היא מוחלת:
   *  ⚠️ ולא במקום אחר בגיליון. */
  213: { claims: { test_visual: ['[class-token]'] } },
  /*  ⭐ סבב 150 — ⛔ קריאה מועברת בחתימה שהפונקציה מקבלת: ⚠️ ארגומנט
   *  עודף נבלע בשקט, ⭐ והמרשם נמדד על המקור המולבן. */
  212: { claims: { test_codescan: ['[call-arity]', '[call-arity-registry]'] } },
  /*  ⭐ סבב 150 — ⛔ השוואה לאפס דורשת שהיעד קיים: ⚠️ אפס מתוך אפס
   *  אינו השלמה, ⭐ והשומר על היעד ולא על ההפרש. */
  190: { claims: { test_codescan: ['[zero-guard]', '[zero-guard-registry]'] } },
  /*  ⭐ סבב 148 — ⛔ כשל מגיע למשטח אחד, ובנוסח שנגזר מההתנהגות:
   *  ⚠️ ערך חריגה על המשטח המוטבע, ⭐ ליטרל עברי בכותב אליו,
   *  ⛔ והבטחת סנכרון מאוחר שאין לה תור. */
  122: { claims: { test_failsurface: ['[fail-surface]', '[fail-literal]', '[queued-msg]', '[msg-shared]'] } },
  /*  ⭐ סבב 148 — ⛔ אסימון עיצוב בדפוס אחד: ⚠️ המספר שנושא מקף,
   *  ⭐ האסימון שחי כאן בלבד ומוצהר, ⛔ והחריץ שעומד במבחן המכני. */
  93: { claims: { test_names: ['[token-pattern]', '[token-app]', '[token-slot]'] } },
  /*  ⭐ סבב 148 — ⛔ טבלת סנכרון נושאת את חמש העמודות: ⚠️ מול הסכימה
   *  המוצהרת, ⭐ וההצהרה נמדדת משני צדדיה. */
  217: { claims: { test_dbscan: ['[sync-cols]', '[sync-cols-why]'] } },
  /*  ⭐ סבב 148 — ⛔ הודעת קומיט נושאת את סבבה: ⚠️ מנקודת ההצהרה
   *  ואילך בלבד, ⭐ ודפוס שאינו של סבב מוצהר. */
  224: { claims: { test_removals: ['[commit-round]'] } },
  /*  ⭐ סבב 148 — ⛔ שם נגזר מדפוס מוצהר: ⚠️ תחילית פונקציה מול התחיליות
   *  החיות של האחיות, ⭐ ההבחנה בין שער למודול לפי «מריץ את עצמו»,
   *  ⛔ ומפריד השם במודול רב-מילי. */
  123: { claims: { test_names: ['[name-policy]', '[name-policy-why]', '[fn-sister-prefix]',
  ...
  /*  ⭐ סבב 148 — ⛔ מרשם חישוב נושא את המקרה הריק: ⚠️ המרשם, הסיווג
   *  שמודפס בפלט, ⭐ וההכרזה שמוצהרת בשני צדדיה. */
  51: { claims: { test_rowscan: ['י · מרשם חישוב נושא את המקרה הריק'] } },
  /*  ⭐ סבב 148 — ⛔ נימוק ⭕ מונה את מה שאינו נאכף: ⚠️ הציטוט שנמצא בתקן,
   *  ⭐ ומספר הסעיפים שמוצהר ב-`APP.gapClauses`. */
  54: { claims: { test_rowscan: ['יא · נימוק ⭕ מונה את מה שאינו נאכף'] } },
  /*  ⭐ סבב 148 — ⛔ מפתח הסימון הוא מפתח המיזוג: ⚠️ השכבות שמוצהרות
   *  ב-`APP.rowKeys`, ⭐ ומטפל הסימון שמקבל מפתח אחד. */
  183: { claims: { test_parentchild: ['[pc-rowkey]'] } },
  /*  ⭐ סבב 148 — ⛔ בלוק חתום נמדד כמו כל קוד: ⚠️ שם מת בתוך בלוק
   *  שאין לו קורא באף אחות, ⭐ ודילוג שאינו אומר מה אינו נמדד בגללו. */
  209: { claims: { test_signeddead: ['[signed-dead]', '[skip-why]'] } },
  /*  ⭐ סבב 148 — ⛔ ערך בקובץ תיאור נמדד מול מקורו: ⚠️ המרשם, הגזירה
   *  שקוראת את מקור האמת, ⭐ ופורמט אחד לתאריך. */
  136: { claims: { test_docfacts: ['[doc-fact]', '[doc-date]'] } },
  /*  ⭐ סבב 148 — ⛔ קובץ תיאור מתאר את האפליקציה שלו: ⚠️ שם קובץ שאין לו
   *  קובץ, ⭐ ואזכור סבב שקדם ללידת האפליקציה. */
  /*  ⛔ שני הצדדים של אותה שורה (סבב 148) — ⚠️ `test_docfacts` מודד את
   *  **הקובץ**, ⭐ ו-`check-capabilities` את **המסך**: ⛔ ומרשם טקסט
   *  דו-ממדי שמצויר הוא תהליך שאין מול מה למדוד אותו. */
  203: { claims: { test_docfacts: ['[doc-name]', '[doc-round]'],
                   'check-capabilities': 'staticProseRegistries' } },
  /*  ⭐ סבב 148 — ⛔ `probe` מודד מימוש ולא הצהרה: ⚠️ כל `probe`
   *  של שורה ✅ נבדק במוטציה שמסירה את המנגנון ומשאירה את ההצהרה. */
  52: { claims: { test_rowscan: ['ט · probe מודד מימוש'] } },
  /*  ⭐ סבב 148 — ⛔ הליבה המשותפת היא מודול: ⚠️ מיקום הקוד, מי טוען אותו
   *  ומי מטמין אותו, ⭐ והזהות בית-לבית בין הריפו. */
  18: { claims: { test_coremod: ['[core-load]', '[core-pure]', '[core-dup]', '[core-twin]', '[core-flag]'] } },
  /*  ⭐ סבב 148 — ⛔ קוד תשתיתי נכתב במודול: ⚠️ תחילית תשתיתית שיושבת
   *  ב-`index.html` מחוץ לבלוק חתום, ⭐ וההכרזה נמדדת משני צדדיה. */
  207: { claims: { test_coremod: ['[core-prefix]', '[core-allow]'] } },
  /*  ⭐ סבב 155 — ⛔ כל שם שנקרא מיובא: ⚠️ שני הכיוונים בטענה אחת,
   *  ⭐ שרשימת הייבוא היא מקור הנתונים האחד לשניהם. */
  19: { claims: { test_coremod: ['[import-use]'] } },
  /*  ⭐ סבב 148 — ⛔ התקופה נגזרת ואינה מאוחסנת: ⚠️ אין טבלה ואין מפתח
  ...
  225: { claims: { test_sistername: ['[sister-name]', '[sister-asset]', '[sister-orphan]'] } },
  226: { claims: { test_toolsid: ['[scan-derived]'] } },
  227: { claims: { test_toolsid: ['[scan-enforcer]'] } },
  /*  ⭐ סבב 148 — ⛔ הערה אינה מפנה לאפליקציה אחרת: ⚠️ בשם הריפו או
   *  בשמה העברי, ⭐ וההכרזה על שם דו-משמעי נמדדת משני צדדיה. */
  117: { claims: { test_sistername: ['[sister-comment]', '[sister-ambig]'] } },
  /*  ⭐ סבב 148 — ⛔ כלי מוצהר הוא כלי שקיים ורץ: ⚠️ שלושת מרשמי הכלים
   *  מול **כל** קובצי `tools/` שבריפו, ⭐ ומולם רשימת הריצה. */
  /*  ⭐ סבב 155 — ⛔ בלוק נושא את סוגו ואת גבולותיו: ⚠️ אפס `<style>`
   *  ב-`index.html`, ⭐ הגיליון בקובץ עם סמניו ובמטמון מראש, ⛔ וכל אתר
   *  שבונה CSS בזמן ריצה מוצהר ונמדד משני צדדיו. */
  59: { claims: { test_coremod: ['[block-kind]', '[block-core]'] } },
  60: { claims: { test_toolsid: ['[tool-uncovered]', '[gate-run]', '[gate-count]'] } },
  /*  ⭐ סבב 145 — ⛔ מפקד נגזר ואינו מוקלד: ⚠️ הסריקה הפוכה ומעוגנת
   ...
   *  ⭐ והאב נדחף לפניו. */
  182: { claims: { test_parentchild: ['[pc-inherit]', '[pc-order-live]'] } },
  /*  ⭐ סבב 144 — ⛔ הגדרת פונקציה נקראת מהמסד: ⚠️ `rename` אינו נוגע
   *  בגוף `plpgsql`, ⭐ ומיגרציה שרצה היא היסטוריה. */
  169: { claim: 'ל1 · ההגדרה החיה נקראה מהמסד' },
  /*  ⭐ סבב 144 — ⛔ כל שער בכולן או מוצהר: ⚠️ הסט המשותף מול
   *  `APP.appGates`, ⭐ והנימוק נמדד בטיבו ⛔ ולא רק בקיומו. */
  24: { claim: '[gate-reason]' },
  25: { claims: { test_filesets: ['[gate-product]', '[gate-browser]'] } },
  /*  ⭐ סבב 144 — ⛔ אין מפתח שירות ואין סכימה מוטבעת: ⚠️ השער חי בכולן,
   *  ⭐ והטענה היא טענת **היעדר** על המקור הגולמי. */
  201: { claim: 'אין `service_role` בקובץ' },
  57: { claim: 'א · אין שתי שורות על אותו probe' },
  39: { claim: 'א · כל דפוס מוכרז נושא מוטציה' },
  35: { claim: 'א · כל מפתח נקרא' },
  /*  ⭐ סבב 141 — ⛔ שם פונקציה חלקי: ⚠️ השער מודד את שני הצדדים,
   *  ⭐ ואת טיב הנימוק — ⛔ הצהרה שהיא נוכחות בלבד נופלת בו. */
  61: { claim: 'fn-undeclared' },
  /*  ⭐ סבב 113 — ⛔ הצד שאינו נמדד בהצהרה עצמה: ⚠️ **שכל היפוך תא עדיין
   *  מפיל אחרי הסינון**, ⛔ ו-`test_matrix` הוא היחיד שמהפך תאים. */
  29: { claim: 'הצהרת קלט הבדיקות' },
  /*  ⭐ סבב 102 — שכבת הדחיפה. ⚠️ שער אחד לשתי השורות: ⛔ שתיהן מודדות
   *  את **אותו** קובץ מכיוון אחד — ⭐ מה עולה לענן, ומאיזה מסלול. */
  71: { claim: 'שכבת הדחיפה' },
  /*  ⛔ שלוש טענות באותו שער (סבב 131) — ⚠️ המשפך, הודעת החסימה שהוא
   *  מחזיר, והקבוע שאתרי האימות מפנים אליו: ⭐ שלושתן על אותו מסלול. */
  204: { claims: { test_push: ['[synclog-decl]', '[synclog-site]', '[synclog-push]'] } },
  72: { claims: { test_push: ['כתיבת משתמש', 'הודעת החסימה', 'הודעת שש הספרות'] } },
  164: { claim: 'בעלות הסכימה המשותפת' },
  178: { claim: '`ya_settings_rishon`' },
  /*  ⛔ שתי הטענות באותו שער — ⚠️ הערכים במסד החי, ⭐ ונקודת הקריאה
   *  שמבחינה בין «אין ערך» ל«ערך פגום»: ⛔ שער אחד לשני הצדדים.  */
  179: { claims: { test_dbfacts: ['י. ערך במפתח-ערך', 'יא. ערך פגום נבדל'] } },
  216: { claim: 'ז. עמודה בלי קורא' },
  96: { claim: 'ליטרל עברי באתר הודעה' },
  ...
  55: { claim: 'תוכן הקבצים הנלווים' },
  /*  ⭐ סבב 155 — ⛔ נכס בינארי יושב בקובץ לפי תפקידו: ⚠️ אפס מוטבע ארוך,
   *  ⭐ כל תיקיית נכסים מוטמנת מראש, ⛔ ודרך טעינה אחת לכל סוג. */
  138: { claims: { test_coremod: ['[asset-file]'] } },
  139: { claims: { test_iconlayer: ['gen-icons', 'מצהיר את ', 'ריק נושא הערת נימוק במקומו'], test_icons: 'master' } },
  142: { claim: 'margin' },
  43: { manual: 'השוואת זמנים בין הריפו אינה בהישג ידו של שער שרץ בריפו אחד — ⛔ נאכפת בתוצאתה בלבד' },
  56: { claim: 'אין פרק פערים נפרד' },
  /*  ⭐ סבב 148 — ⛔ שם פונקציה שחוזר ביותר מריפו אחד בתוכן שונה:
   *  ⚠️ מוצהר ב-`APP.productFns` עם היכולת שמצדיקה, ⭐ ונמדד בטביעת הגוף. */
  125: { claims: { test_codescan: ['[fn-product]'] },
  ...
  53: { manual: 'עדכון הסימון הוא התנהגות סשן שאינה בעץ — ⛔ נאכף רק בתוצאתו', claims: { test_caps_ui: "run(null, null, 'test_caps_ui')", test_caps_build: "run(null, null, 'test_caps_build')", test_caps_guard: "run(null, null, 'test_caps_guard')" } },
  231: { claim: 'CACHE_NAME' },
  45: { manual: 'מספר בדיווח הוא התנהגות סשן שאינה בעץ — ⛔ אין קובץ שאפשר למדוד בו את הדיווח, ⚠️ ונאכף בתוצאתו בלבד' },
  ...
  /*  ⛔ שלושה שערים לשורה אחת (סבב 139) — ⚠️ `check-comments` מודד את
  ...
  38: { claims: { 'check-comments': 'תווית מוטציה מודפסת',
                  'check-capabilities': ['regexBoundGaps', 'anchorGaps'],
                  'test_anchors': 'מ1' } },
  22: { claim: 'תקן הבאנר' },
  16: { claim: 'דפוס הבודקים' },
  109: { claims: { test_visual: ['ליטרל צבע בגיליון', 'ערך שאינו דרגה בסולם', 'ערך מספרי שאינו נגזר'] } },
  110: { claims: { test_visual: ['[util-ratio]', '[util-chain]'] } },
  /*  ⭐ סבב 149 — ⛔ רכיב משותף מתנהג אותו דבר: ⚠️ **נוכחות** המצבים
   *  מוצלבת בין כל הריפו, ⭐ וערכיהם אינם נמדדים — ⛔ שורה שמפילה על
   *  מוצר מייצרת רשימת הצהרות שגדלה בכל שינוי עיצוב. */
  91: { claim: 'מחלקה משותפת שמצביה נבדלים' },
  44: { claim: 'מספרי הבאנר' },
  ...
  98: { claim: 'storage' },
  97: { claim: 'ג · פעולה שדורשת רשת' },
  115: { claim: 'עברית' },
  118: { claims: { 'check-comments': 'RULE_W', 'check-capabilities': 'bannerGaps' } },
  119: { claim: 'BANNER_W' },
  116: { claim: 'מפנה לקובץ' },
  137: { claim: 'android/app/src/main' },
  145: { claim: 'fgDriftMax' },
  146: { claim: 'CANON_MANIFEST' },
  147: { claim: 'שדות זהים' },
  150: { claim: 'BUILD_SHA' },
  154: { claim: 'SHARED_SHA' },
  152: { claim: 'versionCode' },
  133: { claim: 'WebView' },
  134: { claim: 'android:theme' },
  140: { claim: ['מיקום המאסטר אינו מזיז', 'שהמסכה החתוכה היא כל מקורם'] },
  157: { claims: { test_dbfacts: 'ג. כל מפתח שהקוד מבקש', test_dbscan: 'ה. מקור הקריאה', test_read: 'אין ראיה' } },
  161: { claim: 'migrations' },
  170: { claims: { test_dbfacts: ['יב. הרשאות במסד', 'יג. תוספת-בלבד'] } },
  172: { claim: 'א. חותמת בכל רשומה' },
  62: { claims: { 'check-capabilities': 'רענון הממתינים', test_push: 'ה. כשל רשת', test_pendflush: 'pendClear' } },
  165: { claims: { 'check-capabilities': 'colPatternGaps', test_dbfacts: 'ה. דפוס עמודות אחיד' } },
  166: { claim: 'ו. טבלה מקבילה' },
  167: { claim: 'ב. חתימת סכימה' },
  168: { claims: { test_dbscan: ['א. כל שאילתה נפתרת', 'ב. כל שאילתה מול הסכימה המוצהרת'],
                    test_dbfacts: ['טו. מראת הסכימה'] } },
  191: { claim: 'type=password' },
  87: { claim: 'aria-label' },
  ...
  67: { claims: { 'check-capabilities': ['hebdate', 'monthFormGaps', 'hebFormGaps'], test_date: 'hebDate' } },
  197: { claim: 'pass_salt' },
  /*  ⭐ סבב 148 — ⛔ סריקה הפוכה: ⚠️ כל אתר חשוד מפיל אלא אם הוא
   *  מוכרז עם נימוקו, ⭐ ורשימת דפוסים הייתה מוצאת את מה שכבר תוקן. */
  202: { claim: '[sec-keyfile]' },
  206: { claims: { test_filesets: ['[oneoff-gate]', '[oneoff-round]', '[oneoff-stale]'] } },
  210: { claims: { test_orphans: 'כל קובץ בעץ מוזכר במקום אחר',
  ...
  223: { manual: 'מצב הענפים המרוחקים אינו נראה מעותק העבודה' },
  ...
  114: { manual: '«קורא סביר יופתע» אינו נגזר מהטקסט — ⛔ נאכף בתוצאתו בלבד' },
  128: { claim: 'CLEANUP_SHA' },
  129: { claim: 'בלוק ה-APP' },
  187: { claims: { 'check-capabilities': 'cfgKeyGaps', test_dbfacts: 'ג. כל מפתח שהקוד מבקש' } },
  /*  ⛔ שערים שעד סבב 168 רצו בלי שורה — ⚠️ וכל אחד נושא עכשיו את השורה
   *  שהוא אוכף: ⭐ אכיפה בלי שורה מפילה על טענה שאינה בתקן. */
  14: { claims: { 'check-structure': 'הבודקים המשותפים קיימים' } },
  63: { claims: { test_stage_a: 'bkMaybeDaily' } },
  64: { claims: { test_hotwin: 'hwSweep' } },
  65: { claims: { test_merge_pending: 'pending' } },
  66: { claims: { test_ids: 'newClientId' } },
  68: { claims: { test_devid: 'deviceKey' } },
  69: { claims: { test_pendflush: 'RTY_CFG' } },
  70: { claims: { test_pull: 'PL_CFG' } },
  73: { claims: { test_lock: 'LOCK_MS' } },
  74: { claims: { test_session: '_sessUser' } },
  75: { claims: { test_idarg: 'badWraps' } },
  101: { claims: { test_kvmeta: 'kvMeta' } },
  132: { claims: { test_shell: 'ShellActivity' } },
  175: { claims: { test_backup_policy: 'p_keep' } },
  193: { claims: { test_roles: 'admin' } },
  195: { claims: { test_users_patch: 'partialLeak' } },
  198: { claims: { test_offline_login: 'pass_fp' } },
  230: { claims: { test_swcore: 'respondWith' } },
};

/*  ⛔ מדידה מוכרת בפתיחת ההערה ⛔ ולא בספרה (סבב 96) — ⚠️ «נמדד: אפס
 *  בדיקות נוכחות עירומות» הוא מדידה בדיוק כמו «נמדד: 615», ⭐ וספרה
 *  היא היוריסטיקה ולא הטענה.
 *  ⛔⛔ **והסמן יושב כאן ⛔ ולא בשני העותקים** (סבב 105) — ⚠️ שתי נקודות
...
/*  ⛔ טענות המבנה והכיסוי — בשער הליבה בלבד (סבב 137) — ⚠️ הן קוראות את
   ...
   ──────────────────────────────────────────────────────────────────────── */
{
  ...
  /*  ⛔ שם השורה נפתח בטקסט (סבב 106) — ⚠️ הסימן הוא ניסוח ⛔ ולא שם. */
  ...
  /*  ⛔ וסדר הפנים שהכותרת מצהירה מתקיים בפועל (סבב 106) — ⚠️ שורת ה-`↳`
  ...
  /*  ⛔ ומסך אינו מתאר תהליך שמחוץ לקוד (סבב 148) — ⚠️ מרשם טקסט דו-ממדי
  ...
  /*  ⛔ ושכבת החותמת הפר-מפתחית מוצהרת (סבב 145) — ⚠️ הטבלה שהיא
  ...
  /*  ⛔ ושער נמדד גם בגודלו (סבב 137) — ⚠️ שער אחד ארוך חוסם את הבריכה,
  ...
  /*  ⛔ וליטרל צבע בסגנון מוטבע (סבב 137) — ⚠️ הטענה רצה תמיד ⛔ ואינה
  ...
  /*  ⛔ ו-probe שבודק נוכחות ולא מיקום (סבב 138) — ⚠️ הטענה רצה תמיד
  ...
  /*  ⚠️ כל התאים ולא התא של האפליקציה הזו (סבב 72) — ⛔ ההערה משותפת
 ...
 *  משניהם מפילה כאן, ⛔ ולא מתגלה סבבים אחר כך. */
{
  ...
  /*  ⭐ שורה רשאית לשבת גם ב-`MATRIX` וגם ב-`GATES` (סבב 168) — ⚠️ ה-probe
  ...
  /*  ⛔⛔ טענה בלי מוטציה ובלי שורת נימוק (סבב 167) — ⚠️ ה-probe מדד
   *  **שערים**, ⛔ וטענה בתוך שער אינה שער: ⭐ והיא חמקה.
   *  ⛔ **ושני הצדדים מפילים** — ⚠️ טענה בלי מוטציה ובלי נימוק,
   *  ⛔ והכרזה שאין לה טענה כזו. */
  const HARNESS_MUT = fs.existsSync('tools/test_rulesdocs.mjs')
    ? readOnce('tools/test_rulesdocs.mjs') : '';
...
/* ────── ⛔ בדיקה מוצהרת לפי הקלט שהיא קוראת (סבב 113) ───────────────────────
   ...
   נמדד ב-`test_matrix`, שהוא היחיד שמהפך תאים.
   ──────────────────────────────────────────────────────────────────────── */
...
function touchesSrc(fn) {
  ...
  while (stack.length) {
    ...
    for (const id of t.match(/[A-Za-z_$][\w$]*/g) || []) {
      /*  ⛔ המפה נשאלת בבעלות ולא ב-`map[id]` (סבב 115) — ⚠️ `hasOwnProperty`
...
/*  ⛔ כל שורה בדיוק בשער אחד (סבב 137) — ⚠️ החלק נגזר מאות הקטגוריה
...
for (const m of MATRIX) {
  ...
  /*  ⛔ מדידה מוחרגת גם כאן (סבב 72) — ⚠️ שתי נקודות אכיפה לאותה טענה,
   *  ⭐ ושתיהן קוראות את **אותו** סמן: ⛔ תיקון באחת בלבד השאיר את
   *  השנייה סותרת אותה, ⚠️ ובדיוק זה קרה בין סבב 96 לסבב 105. */
  ...
  /*  ⛔ בדיקה שהקלט שלה לא השתנה אינה רצה שוב (סבב 113) — ⚠️ התוצאה
...
if (!changed) {
  ...
  /*  ⛔ הכיוון «בלי הצהרה» הוא של החלק (סבב 137) — ⚠️ רק הוא הריץ את
...
const N = PRE_MUT || RAN;
/*  ⛔ מספר הטענות של הריצה הזו נחשף לשער שקרא (סבב 137) — ⚠️ כל חלק
