...
const APP = {
  ...
  queuedMsgs: {
    ...
    MSG_WILL_RESEND: 'הקטגוריות שנכשלו נשארו בתור ונדחפות בניסיון החוזר — ⛔ וההבטחה נכונה',
    MSG_SOME_UNSYNCED_POST: 'שאריות אותו מחזור דחיפה, ⛔ ואותו תור בדיוק',
  },
  ...
  msgPerApp: {
    MSG_BAD_LOGIN: 'הנוסח נבדל בהחלטת מנהל — ⚠️ וסימן השגיאה הפותח נבדל איתו',
    MSG_NO_FP_ONLINE: 'המסלול לתיקון נבדל — ⛔ כאן יש מסך ניהול משתמשים ובאחות אין',
  },
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
