...
const APP = {
  ...
  gapRows: [226, 144, 148, 172, 67, 157, 110],
...
export const ROWS = [34, 48, 49, 58, 98, 56, 186, 117, 164, 62, 27, 67, 30, 38, 42, 202, 209];
...
const GATES = {
  ...
  229: { manual: 'המסך הראשון מול מסד ריק אינו נגזר מהטקסט — ⛔ הוא נמדד במבחן הקבלה, ⚠️ ושער אינו מריץ דפדפן' },
  ...
  138: { claim: ['gen-icons', 'מצהיר את ', 'ריק נושא הערת נימוק במקומו'] },
  141: { claim: 'margin' },
  ...
  156: { claims: { test_dbfacts: 'ג. כל מפתח שהקוד מבקש', test_dbscan: 'ה. מקור הקריאה' } },
