...
const EXEMPT = [
  ...
  212, 219,  /* אכיפתן ב-test_dbscan וב-test_removals, ומוצהרות ב-GATES */
  119,        /* «שם נגזר מדפוס מוצהר» — אכיפתה ב-test_names, ומוצהרת ב-GATES */ /* הוסט בסבב הנוכחי */
  120, 213,   /* אכיפתן ב-test_period וב-test_cron, ומוצהרות ב-GATES */
  24,         /* אכיפתה ב-test_filesets וב-test_behavior, ומוצהרת ב-GATES */
  83, 104, 185, 207, 208,  /* אכיפתן ב-test_visual וב-test_codescan, ומוצהרות ב-GATES */
  ...
  186, 86, 66, 192, 197, 201, 205, 211, 214, 215, 216, 218, 220, 224, 174, 107, 60,
  217, 94, 34, 39, 57, 35, 164, 196, 52, 177, 19, 59, 114, 46, 117, 225, 18, 202
];
