...
const APP = {
  ...
  project: 'shared',
  /*  ⛔ סכימת שני הפרויקטים — ⚠️ **מה נכנס**: `p` הפרויקט · `t` שם הטבלה ·
   ...
   *  ⛔ **והגוף זהה בית-לבית בארבעת הריפו** — ⚠️ ארבעה עותקים של סכימה
  ...
  dbSchema: [
    ...
    { p: 'shared', t: 'ys_sleep_marks',   c: 'client_id,session_client_id,student_id,date_iso,status,minutes,deleted,updated_at,synced_at,deleted_at,deleted_by,note' },
  ...
  dbTables: ['kv_backup', 'sync_log', 'ys_marks', 'ys_sessions', 'ys_settings',
