...
export const ROWS = [38, 40, 41, 43, 58];
...
const GATES = {
  ...
  38: { claim: 'כיסוי הטבלה' },
  39: { claim: 'עמודת «מה זה» היא הוראה מחייבת' },
  ...
  54: { claim: 'CANON' },
  58: { claim: 'storage' },
  59: { manual: 'דפוס הודעת השגיאה טרם הוכרע, ואין מה לאכוף' },
  ...
  66: { claim: 'מספר סבב' },
  67: { claim: 'CSS מתות' },
  68: { manual: '«האם ההערה עדיין נכונה» הוא התאמה למציאות ולא צורה — ⛔ שער מודד צורה בלבד' },
  69: { claim: 'מפנה לקובץ' },
