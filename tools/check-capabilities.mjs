...
const APP = {
  ...
  gapRows: [227, 145, 149, 173, 68, 158, 111],
...
export const ROWS = [34, 49, 50, 59, 99, 57, 187, 118, 165, 63, 27, 68, 30, 39, 43, 203, 210];
...
const GATES = {
   ...
   *  ⛔ בעכבר ובמגע. */
  91: { claims: { test_behavior: ['[drag-api]', '[drag-grip]', '[drag]'] } },
  ...
  120: { claims: { test_period: ['[verb-registry]', '[verb-old-name]'],
                   ...
                   test_visual: ['[shared-surface]', '[dialog-surface]'] } },
  ...
  230: { claims: { test_behavior: ['fresh'] } },
