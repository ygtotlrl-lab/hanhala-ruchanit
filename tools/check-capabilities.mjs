...
const APP = {
  ...
  gapRows: [216, 48, 136, 140, 164, 68, 149, 106],
  ...
  probeInput: {
    ...
    '215|מיכל באנר העדכון במקור': 'src',
    '215|הרענון מ-controllerchange בלבד': 'src',
    '215|סימן דחיית הבאנר מתמיד': 'src',
    '119|רישום כשלי כתיבה': 'src',
    '65|חלון חם במכשיר': 'src',
    '182|מסך שינוי סיסמה עצמי': 'src',
    '217|מטמון-CDN מראש עם ריפוי עצמי': 'src',
...
const MATRIX = [
  ...
  { row: 217, name: 'מטמון-CDN מראש עם ריפוי עצמי',
  ...
  { row: 217, name: 'מודול ה-service worker',
...
/*  ⭐ סבב 52 — נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 216, name: 'בדיקת עדכון תקופתית ל-service worker',
  ...
  { row: 215, name: 'מיכל באנר העדכון במקור',
  ...
  { row: 215, name: 'הרענון מ-controllerchange בלבד',
    probe: () => swReloadGaps().length === 0 },
  { row: 215, name: 'סימן דחיית הבאנר מתמיד',
    probe: () => swDismissGaps().length === 0 },
  { row: 215, name: 'עדכון אוטומטי — בדיקה מחזורית',
...
const GATES = {
  ...
  213: { manual: 'מצב הענפים המרוחקים אינו נראה מעותק העבודה' },
