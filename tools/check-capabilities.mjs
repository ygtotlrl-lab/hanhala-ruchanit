...
const APP = {
  ...
  gapRows: [222, 140, 144, 168, 66, 153, 108],
  ...
  probeInput: {
    ...
    '98|שכבת המראה': 'src',
    '209|הגירה מקומית שהושלמה': 'mixed',
    ...
    '221|מיכל באנר העדכון במקור': 'src',
    '221|הרענון מ-controllerchange בלבד': 'src',
    '221|סימן דחיית הבאנר מתמיד': 'src',
    '123|רישום כשלי כתיבה': 'src',
    '63|חלון חם במכשיר': 'src',
    '187|מסך שינוי סיסמה עצמי': 'src',
    '223|מטמון-CDN מראש עם ריפוי עצמי': 'src',
...
export const ROWS = [33, 48, 49, 58, 96, 56, 182, 115, 160, 61, 26, 66, 29, 38, 42, 198, 205];
...
const MATRIX = [
  ...
  { row: 223, name: 'מטמון-CDN מראש עם ריפוי עצמי',
  ...
  { row: 223, name: 'מודול ה-service worker',
...
/*  ⭐ סבב 52 — נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 222, name: 'בדיקת עדכון תקופתית ל-service worker',
  ...
  { row: 209, name: 'הגירה מקומית שהושלמה',
  ...
  { row: 221, name: 'מיכל באנר העדכון במקור',
  ...
  { row: 221, name: 'הרענון מ-controllerchange בלבד',
    probe: () => swReloadGaps().length === 0 },
  { row: 221, name: 'סימן דחיית הבאנר מתמיד',
    probe: () => swDismissGaps().length === 0 },
  { row: 221, name: 'עדכון אוטומטי — בדיקה מחזורית',
...
const GATES = {
  ...
  217: { claims: { test_mignames: ['[mig-pattern]', '[mig-seq]', '[mig-file-no-entry]',
  ...
  205: { claims: { test_orphans: 'כל קובץ בעץ מוזכר במקום אחר',
  ...
  214: { claim: 'ט. ערך נגזר שהתיישן' },
  216: { claim: 'ח. הגדרה שהוחלפה' },
  215: { claim: 'ד. רשימת-היתר' },
  218: { manual: 'מצב הענפים המרוחקים אינו נראה מעותק העבודה' },
