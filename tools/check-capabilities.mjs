...
const APP = {
  ...
  actMap: 'DOM_ACTIONS',
  gapRows: [38, 105, 109, 127, 128, 132, 142],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    146: (c) => c.hasCode(/YS_PASS_ITER\s*=\s*100000\b/)
    ...
    145: (c) => !!c.fnBody('ysUsersCacheSave')
    ...
    144: (c) => !!c.fnBody('changeMyPassword')
...
export const ROWS = [27, 37, 39, 41, 50, 72, 44, 137, 85];
...
const MATRIX = [
  ...
  { row: 154, name: 'הערה שמתארת מצב שחלף',
  ...
  { row: 156, name: 'פונקציה בלי קוראים',
  ...
  { row: 150, name: 'סודות אינם עוזבים את המכשיר',
    probe: () => {
  ...
  { row: 148, name: 'טביעה חסרה מושלמת אוטומטית',
  ...
  { row: 149, name: 'סיסמאות בענן — אין מסלול שכותב או קורא טקסט גלוי',
    probe: () => {
  ...
  { row: 152, name: 'דגלי מעבר — אין דגל דלוק',
  ...
  { row: 145, name: 'נתיב עדכון חלקי למראת המשתמשים', app: true },
  ...
  { row: 138, name: 'אימות פינוי מול הענן',
  ...
  { row: 143, name: 'רישום כשלי כתיבה', probe: () => silentWriteCatches().length === 0 },
  ...
  { row: 144, name: 'מסך שינוי סיסמה עצמי', app: true },
  { row: 163, name: 'מטמון-CDN מראש עם ריפוי עצמי',
  ...
  { row: 148, name: 'חסימת משתמש מושבת בכניסה אופליין',
  ...
  { row: 148, name: 'אימות מול טביעה בענן',
    probe: () => {
  ...
  { row: 163, name: 'מודול ה-service worker',
...
/*  ⭐ סבב 52 — נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 162, name: 'בדיקת עדכון תקופתית ל-service worker',
  ...
  { row: 161, name: 'עדכון אוטומטי — בדיקה מחזורית',
...
const GATES = {
  ...
  136: { claim: 'ב. חתימת סכימה' },
  140: { claim: 'type=password' },
  141: { claim: 'aria-label' },
  142: { manual: 'מנוע התאריך — ⛔ נאכף ב-`test_date` ביומן ובהנהלה, ⚠️ ובשכר ובגיוס אין צרכן תאריך עברי ואין שער' },
  147: { claim: 'pass_salt' },
  151: { manual: 'היעדר סוד נסרק ידנית; ⛔ שער טקסטואלי היה נכשל על כל מחרוזת' },
  153: { claim: '⏳' },
  46: { manual: 'התאמת הערה למציאות אינה ניתנת לאכיפה מכנית' },
  155: { claim: 'כל קובץ בעץ מוזכר במקום אחר' },
  159: { claim: 'ד. רשימת-היתר' },
  160: { manual: 'מצב הענפים המרוחקים אינו נראה מעותק העבודה' },
  ...
  91: { claim: 'בלוק ה-APP' },
  137: { claims: { 'check-capabilities': 'cfgKeyGaps', test_dbfacts: 'ג. כל מפתח שהקוד מבקש' } },
};
