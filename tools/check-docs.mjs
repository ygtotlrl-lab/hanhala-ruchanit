...
export const ROWS = [2, 3, 4, 6, 7, 9, 10, 11, 12, 13, 106, 165];

/* הרשימה הקנונית — מזהה ← חתימת sha256 (16 תווים) של תוכן הבלוק, מקוצץ. */
const CANON = [
  ['table', 'e824082bf01a5714'],
];
 ...
 *  הסימון לפסקה שאינה זהה בארבעתן בפועל — זו בדיוק אותה סחיפה,
 *  בציר אחר.                                                             */
...
/* ────── יב. סדר הבלוקים (סבב 71; ⛔ פרקי הכללים ירדו בסבב 96) ───────────────
   ⛔ **סדר הבלוקים נאכף מול הרשימה הקנונית** — ⚠️ הרשימה זהה בארבעת
