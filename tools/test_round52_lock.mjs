...
const APP = {
   ...
   *  ⭐ מסבב 53 הוא `null` **בארבעתן** (מטריצה, שורה 35), והאכיפה
   *  המלאה עברה ל-`test_round53_session.mjs`; הטענה כאן נשארת כשכבה
...
/* ── 9. סשן שנשמר במכשיר — נמדד ומושווה להצהרה (מטריצה, שורה 35) ───────── */
