...
const APP = {
  ...
  gapRows: [226, 144, 148, 172, 68, 157, 110],
...
export const ROWS = [34, 49, 50, 59, 98, 57, 186, 117, 164, 63, 27, 68, 30, 39, 43, 202, 209];
...
const GATES = {
  ...
  47: { claims: { test_period: ['[period-store]', '[period-calendar]'] } },
  ...
  25: { claims: { test_filesets: '[gate-product]', test_behavior: '[accept]' } },
  ...
  141: { claim: 'margin' },
  44: { manual: 'השוואת זמנים בין הריפו אינה בהישג ידו של שער שרץ בריפו אחד — ⛔ נאכפת בתוצאתה בלבד' },
   ...
   *  מוטציה שאין בו. */
  37: { claim: 'לכל אחד שינוי, תווית' },
  38: { claim: 'שם הטענה שתיפול' },
  34: { claim: ['כיסוי הטבלה', 'הפניות GATES'] },
  48: { claim: 'ועמודת התקן שלה אוסרת במפורש' },
  49: { claim: ['מספור רציף ובלי כפילויות', 'nameSignGaps', 'catOrderGaps'] },
  50: { claims: { 'check-capabilities': ['הערה ריקה', 'COUNT_NOTE'],
                  'check-comments': 'פתיחת ההערה בטבלה' } },
  54: { manual: 'עדכון הסימון הוא התנהגות סשן שאינה בעץ — ⛔ נאכף רק בתוצאתו' },
  228: { claim: 'CACHE_NAME' },
  46: { manual: 'מספר בדיווח הוא התנהגות סשן שאינה בעץ — ⛔ אין קובץ שאפשר למדוד בו את הדיווח, ⚠️ ונאכף בתוצאתו בלבד' },
