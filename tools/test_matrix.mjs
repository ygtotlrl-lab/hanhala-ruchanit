...
const EXEMPT = [
  ...
  19, 59, 138,  /* «כל שם שנקרא — מיובא» · «בלוק נושא את סוגו» · «נכס בינארי יושב בקובץ» — אכיפתן ב-test_coremod, ומוצהרות ב-GATES */
  121, 124, 218,   /* אכיפתן ב-test_period וב-test_cron, ומוצהרות ב-GATES */
  25,         /* אכיפתה ב-test_filesets, ומוצהרת ב-GATES */
  84, 106, 190, 212, 213,  /* אכיפתן ב-test_visual וב-test_codescan, ומוצהרות ב-GATES */
  ...
  222, 96, 35, 39, 57, 169, 201, 52, 182, 20, 60, 117, 46, 120, 230, 18, 206
];
